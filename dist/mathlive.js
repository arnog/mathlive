...
(global = this),
    (factory = function() {
        function t(t, e) {
            ...
            if (55296 <= i && i <= 56319 && e < t.length - 1) {
                const s = i,
                    a = t.charCodeAt(e + 1);
        ...
        function e(e, s) {
            if ((s = s || 0) < 0) return 0;
            if (s >= e.length - 1) return e.length;
            let a = i(t(e, s));
            for (let r = s + 1; r < e.length; r++) {
                if (
                    55296 <= e.charCodeAt(r - 1) &&
                    e.charCodeAt(r - 1) <= 56319 &&
                    56320 <= e.charCodeAt(r) &&
                    e.charCodeAt(r) <= 57343
                )
                    continue;
                const s = i(t(e, r));
                if (
        ...
        var s = function(t) {
            ...
            let s,
                a = 0;
            for (; (s = e(t, a)) < t.length; ) i.push(t.slice(a, s)), (a = s);
            return a < t.length && i.push(t.slice(a)), i;
        };
        class a {
            constructor(t, e) {
        ...
        class o {
            ...
            scan(t) {
                ...
                return (
                    ...
                    e ? ((this.pos += e[0].length), e[0]) : null
                );
            }
            isWhiteSpace() {
            ...
            makeToken() {
                ...
                if (this.isWhiteSpace()) return this.get(), new a('space');
                let t = null;
                if ('\\' === this.peek()) {
                    ...
                    '~' === this.peek()
                        ? (this.get(), (t = new a('command', 'space')))
                        : '$' === this.peek()
                        ? (this.get(),
                          '$' === this.peek()
                              ? (this.get(), (t = new a('$$')))
                              : (t = new a('$')))
                        : (t = new a('literal', this.get()));
                return t;
            }
        }
        var n = function(t) {
                const e = [],
                    i = t.toString().split(/\r?\n/);
                let s = '',
                    a = '';
                for (const t of i) {
                    (s += a), (a = ' ');
        ...
        function p(t, e, i) {
            if ('string' == typeof t) {
                const i = t.match(/([-+]?[0-9.]*)\s*([a-zA-Z]+)/);
                i
                    ? ((t = parseFloat(i[1])), (e = i[2].toLowerCase()))
                    : (t = parseFloat(t));
            }
            const s =
                {
            ...
            if (isFinite(i)) {
                ...
                return Math.round((t / h.ptPerEm) * s * e) / e;
            }
            return (t / h.ptPerEm) * s;
        }
        var m = {
            toEm: p,
            toPx: function(t, e) {
                return p(t, e) * (4 / 3) * h.ptPerEm;
            },
            METRICS: h,
            SIGMAS: c,
            getCharacterMetrics: function(t, e) {
                const i =
                    {
        ...
        for (const t in c)
            if (Object.prototype.hasOwnProperty.call(c, t))
                for (f = 0; f < 3; f++) u[f][t] = c[t][f];
        for (f = 0; f < 3; f++) u[f].emPerEx = c.xHeight[f] / c.quad[f];
        class g {
            constructor(t, e, i, s) {
                (this.id = t),
                    (this.size = e),
        ...
        class C {
            constructor(t) {
                (this.macros = t.macros || {}),
                    (this.generateID = !!t.generateID && t.generateID),
                    (this.mathstyle = M.toMathstyle(
                        t.mathstyle || 'displaystyle'
                    )),
                    (this.size = t.size || 'size5'),
                    (this.parentMathstyle =
                        t.parentMathstyle || this.mathstyle),
            ...
            clone(t) {
                ...
                return (
                    ...
                    (e.macros = this.macros),
                    t &&
                        (('auto' !== t.mathstyle && t.mathstyle) ||
                            delete t.mathstyle,
                        Object.assign(e, t),
                        'string' == typeof t.mathstyle &&
                            (e.mathstyle = M.toMathstyle(t.mathstyle))),
                    e
                );
            }
            setMathstyle(t) {
                t && 'auto' !== t && (this.mathstyle = M.toMathstyle(t));
            }
            cramp() {
        ...
        function T(t) {
            let e = '';
            if ('number' == typeof t) e += Math.floor(100 * t) / 100;
            else if ('string' == typeof t) e += t;
            else if (Array.isArray(t)) for (const i of t) e += T(i);
            else t && (e += t.toString());
            return e;
        }
        class L {
            ...
            applyStyle(t) {
                ...
                if (
                    ...
                    const e = t.fontSeries.match(/(.?[lbm])?(.?[cx])?/);
                    e &&
                        ((this.classes +=
                            ' ' +
                            ({
                ...
                if (
                    ...
                    for (let t = 0; t < this.body.length; t++) {
                        const e = m.getCharacterMetrics(this.body.charAt(t), i);
                        e &&
            ...
            setStyle(t, ...e) {
                const i = T(e);
                i.length > 0 &&
                    (this.style || (this.style = {}), (this.style[t] = i));
            }
            setTop(t) {
                t &&
                    0 !== t &&
                    (this.style || (this.style = {}),
                    (this.style.top = T(t) + 'em'),
                    (this.height -= t),
                    (this.depth += t));
            }
            setLeft(t) {
                t &&
                    0 !== t &&
                    (this.style || (this.style = {}),
                    (this.style['margin-left'] = T(t) + 'em'));
            }
            setRight(t) {
                t &&
                    0 !== t &&
                    (this.style || (this.style = {}),
                    (this.style['margin-right'] = T(t) + 'em'));
            }
            setWidth(t) {
                t &&
                    0 !== t &&
                    (this.style || (this.style = {}),
                    (this.style.width = T(t) + 'em'));
            }
            addMarginRight(t) {
                if (t && 0 !== t) {
                    if (
                        ...
                        if (e) return void (this.classes += ' rspace ' + e);
                    }
                    this.style || (this.style = {});
                    const e = parseFloat(this.style['margin-right'] || '0');
                    this.style['margin-right'] = T(e + t) + 'em';
                }
            }
            toMarkup(t, e) {
                (t = t || 0), (e = e || 1);
                ...
                if (
                    ...
                    this.type &&
                        (/command|placeholder|error/.test(this.type) &&
                            e.push(
                                {
                                    command: 'ML__command',
                            ...
                            e.length > 1
                                ? e
                                      .filter(function(t, e, i) {
                                          return (
                                              t.length > 0 && i.indexOf(t) === e
                                          );
                                      })
                                      .join(' ')
                                : e[0]),
                        a.length > 0 && (i += ' class="' + a + '"'),
                        t &&
                        ...
                        this.svgOverlay
                            ? ((i += '<span style="'),
                              ...
                              (i +=
                                  ...
                                  Math.round(
                                      m.toPx(this.depth, 'em') +
                                          m.toPx(this.style.padding)
                                  ) +
                                  'px);'),
            ...
            tryCoalesceWith(t) {
                ...
                for (let t = 0; t < s.length; t++) {
                    if ('vertical-separator' === s[t]) return !1;
                    if (s[t] !== a[t]) return !1;
                }
        ...
        var N = {
            coalesce: function t(e) {
                ...
                for (let s = 1; s < e.length; s++)
                    i[i.length - 1].tryCoalesceWith(e[s]) ||
            ...
            makeVlist: function(t, e, i, s) {
                ...
                if ('shift' === i) a = -e[0].depth - s;
                    ...
                    let t = s;
                    for (const i of e)
                        t -= i instanceof L ? i.height + i.depth : i;
                    a = t;
                } else if ('individualShift' === i) {
                    const t = e;
                    (e = [t[0]]), (a = -t[1] - t[0].depth), (o = a);
                    for (let i = 2; i < t.length; i += 2) {
                        const s = -t[i + 1] - o - t[i].depth;
                        o += s;
                        const a = s - (t[i - 2].height + t[i - 2].depth);
                        e.push(a), e.push(t[i]);
                    }
                }
                let n = 1;
                for (const t of e)
                    t instanceof L && (n = Math.max(n, t.maxFontSize));
                const r = (function(t, e) {
                        const i = e ? e / t.mathstyle.sizeMultiplier : 0,
                            s = new L('​');
                        return (
                            1 !== i &&
                                (s.setStyle('font-size', i, i > 0 ? 'em' : ''),
                                (s.attributes = { 'aria-hidden': !0 })),
                            'size5' !== t.size
                                ? new L(
                                      s,
                                      'fontsize-ensurer reset-' +
                                          t.size +
                                          ' size5'
                                  )
                                : 0 !== i
        ...
        function J(t, ...e) {
            const i = 'string' == typeof t ? X[t] : t;
            for (const t of e)
                H[t] && (H[t].frequency = i),
                    V[t] &&
                        ((V[t] = Object.assign({}, V[t])),
                        (V[t].frequency = i));
        }
        function Y(t, e, i, s, a) {
            e && /^(ams|cmr|bb|cal|frak|scr)$/.test(e),
        ...
        function et(t, e) {
            ...
            if ('math' === t && tt[i]) return tt[i];
            if (e > 32 && e < 127) return i;
            let s = '';
            if ('math' === t) {
                for (const t in H)
                    if (
                ...
                for (const t in vt)
                    if (
                        Object.prototype.hasOwnProperty.call(vt, t) &&
                        vt[t] === i
                    ) {
                        s = t;
                        break;
        ...
        function at(t) {
            let e = t;
            if (
                ('string' == typeof t && (e = t.codePointAt(0)),
                (e < 119808 || e > 120831) && (e < 8448 || e > 8527))
            )
                return { char: t };
            for (const t in it)
                if (
            ...
            for (let t = 0; t < st.length; t++)
                if (e >= st[t].start && e < st[t].start + st[t].len)
                    return {
                        char: String.fromCodePoint(
                            e - st[t].start + st[t].offset
                        ),
                        variant: st[t].variant,
                        style: st[t].style,
                    };
            return { char: t };
        }
        function ot(t, e) {
            if ('text' === t) return String.fromCodePoint(e);
            let i;
            if (tt[e]) return tt[e];
            const s = at(e);
            return s.style || s.variant
                ? ((i = s.char),
                  s.variant && (i = '\\' + s.variant + '{' + i + '}'),
                  'bold' === s.style
                      ? (i = '\\mathbf{' + i + '}')
                      : 'italic' === s.style
                      ? (i = '\\mathit{' + i + '}')
        ...
        function ut(t, e) {
            ...
            return (
                ...
                (i = t.match(/^([^:=]+)/)),
                i && (o = i[1].trim()),
                { optional: e, type: a, defaultValue: s, placeholder: o }
            );
        }
        function ft(t) {
            ...
            let e = [],
                i = t.split(']');
            if ('[' === i[0].charAt(0)) {
                e.push(ut(i[0].slice(1), !0));
                for (let t = 1; t <= i.length; t++) e = e.concat(ft(i[t]));
            } else if (((i = t.split('}')), '{' === i[0].charAt(0))) {
                e.push(ut(i[0].slice(1), !1));
                for (let t = 1; t <= i.length; t++) e = e.concat(ft(i[t]));
            }
            return e;
        }
        function gt(t) {
            return t.map(t => t.body).join('');
        }
        function yt(t, e, i, s) {
            'string' == typeof t && (t = [t]), i || (i = {});
            const a = ft(e),
                o = {
                    category: W,
                    params: a,
                    ...
                    tabular: i.tabular || !0,
                    colFormat: i.colFormat || [],
                };
            for (const e of t) U[e] = o;
        }
        function bt(t, e, i, s) {
            'string' == typeof t && (t = [t]), i || (i = {});
            const a = {
                category: W,
                baseFontFamily: i.fontFamily,
                params: ft(e),
                allowedInText: !!i.allowedInText,
                infix: !!i.infix,
                parse: s,
            };
            for (const e of t) V[e] = a;
        }
        (W = 'Environments'),
            yt('math', '', { frequency: 0 }, function() {
                return { mathstyle: 'textstyle' };
            }),
            yt('displaymath', '', { frequency: 8 }, function() {
                return { mathstyle: 'displaystyle' };
            }),
            yt('array', '{columns:colspec}', { frequency: G }, function(t, e) {
                return { colFormat: e[0], mathstyle: 'textstyle' };
            }),
            yt('eqnarray', '', {}, function() {
                return {};
            }),
            yt('equation', '', {}, function() {
                return { colFormat: [{ align: 'c' }] };
            }),
            yt('subequations', '', {}, function() {
                return { colFormat: [{ align: 'c' }] };
            }),
            yt('multline', '', {}, function() {
                return {
            ...
            yt(['align', 'aligned'], '', {}, function(t, e, i) {
                let s = 0;
                for (const t of i) s = Math.max(s, t.length);
                const a = [
                    { gap: 0 },
                    { align: 'r' },
                    { gap: 0 },
                ...
                for (; o < s; )
                    a.push({ gap: 1 }),
                        ...
                        a.push({ align: 'l' }),
                        (o += 2);
                return a.push({ gap: 0 }), { colFormat: a, jot: 0.3 };
            }),
            yt('split', '', {}, function() {
                return {};
            }),
            yt(['gather', 'gathered'], '', {}, function() {
                return {
            ...
            yt(
                ...
                function(t, e) {
                    ...
                    switch (t) {
                        ...
                        case 'Bmatrix':
                        case 'Bmatrix*':
                            (i.lFence = '\\lbrace'), (i.rFence = '\\rbrace');
                            break;
                        case 'vmatrix':
                        case 'vmatrix*':
                            (i.lFence = '\\vert'), (i.rFence = '\\vert');
                            break;
                        case 'Vmatrix':
                        case 'Vmatrix*':
                            (i.lFence = '\\Vert'), (i.rFence = '\\Vert');
            ...
            bt(['\\det', '\\max', '\\min'], '', null, function(t) {
                return {
                    type: 'mop',
                    limits: 'limits',
                    symbol: !1,
            ...
            bt('\\color', '{:color}', { allowedInText: !0 }, (t, e) => ({
                color: e[0],
            })),
            bt(
                '\\textcolor',
            ...
            J(3, '\\textcolor'),
            bt('\\overline', '{:auto}', null, function(t, e) {
                return {
                    type: 'line',
                    position: 'overline',
                    skipBoundary: !0,
            ...
            J(G, '\\overline'),
            bt('\\underline', '{:auto}', null, function(t, e) {
                return {
                    type: 'line',
                    position: 'underline',
                    skipBoundary: !0,
            ...
            J(G, '\\underline'),
            bt('\\overset', '{annotation:auto}{symbol:auto}', null, function(
                t,
                e
            ) {
                return {
            ...
            J(G, '\\overset'),
            bt('\\underset', '{annotation:auto}{symbol:auto}', null, function(
                t,
                e
            ) {
                return {
            ...
            J(G, '\\stackrel'),
            J(0, '\\stackbin'),
            bt('\\rlap', '{:auto}', null, function(t, e) {
                return {
                    type: 'overlap',
                    align: 'right',
                    skipBoundary: !0,
            ...
            J(270, '\\rlap'),
            bt('\\llap', '{:auto}', null, function(t, e) {
                return {
                    type: 'overlap',
                    align: 'left',
                    skipBoundary: !0,
            ...
            J(18, '\\llap'),
            bt('\\mathrlap', '{:auto}', null, function(t, e) {
                return {
                    type: 'overlap',
                    mode: 'math',
                    align: 'right',
            ...
            J(j, '\\mathrlap'),
            bt('\\mathllap', '{:auto}', null, function(t, e) {
                return {
                    type: 'overlap',
                    mode: 'math',
                    align: 'left',
            ...
            J(j, '\\mathllap'),
            bt('\\boxed', '{content:math}', null, function(t, e) {
                return {
                    type: 'box',
                    framecolor: 'black',
                    skipBoundary: !0,
            ...
            J(j, '\\fcolorbox'),
            bt('\\bbox', '[:bbox]{body:auto}', { allowedInText: !0 }, function(
                t,
                e
            ) {
                return e[0]
                    ? {
                          ...
                          padding: e[0].padding,
                          border: e[0].border,
                          backgroundcolor: e[0].backgroundcolor,
                          skipBoundary: !0,
                          body: e[1],
                      }
                    : { type: 'box', skipBoundary: !0, body: e[1] };
            }),
            J(j, '\\bbox'),
            bt(
                '\\enclose',
                ...
                function(t, e) {
                    ...
                    if (e[1]) {
                        ...
                        for (const e of t) {
                            ...
                            if (t)
                                (s.strokeWidth = m.toPx(t[1], 'px')),
                                    isFinite(s.strokeWidth) ||
                                        (s.strokeWidth = 1),
                                    (s.strokeStyle = t[2]),
                                    (s.strokeColor = t[3]);
                            else {
                        ...
                        'dashed' === s.strokeStyle
                            ...
                            : 'dotted' === s.strokeStyle &&
                              (s.svgStrokeStyle = '1,5');
                    }
                    (s.borderStyle =
                        s.strokeWidth +
                        'px ' +
                        ...
                        (i = i
                            ...
                            .map(t => t.toLowerCase())),
                        (s.notation = {});
                    for (const t of i) s.notation[t] = !0;
                    return (
                        s.notation.updiagonalarrow &&
                            (s.notation.updiagonalstrike = !1),
                        s.notation.box &&
                            ((s.notation.left = !1),
                            (s.notation.right = !1),
                            (s.notation.bottom = !1),
            ...
            J(j, '\\enclose'),
            bt('\\cancel', '{body:auto}', null, function(t, e) {
                return {
                    type: 'enclose',
                    strokeColor: 'currentColor',
                    strokeWidth: 1,
                    ...
                    padding: 'auto',
                    shadow: 'auto',
                    notation: { updiagonalstrike: !0 },
                    body: e[0],
                };
            }),
            bt('\\bcancel', '{body:auto}', null, function(t, e) {
                return {
                    type: 'enclose',
                    strokeColor: 'currentColor',
                    strokeWidth: 1,
                    ...
                    padding: 'auto',
                    shadow: 'auto',
                    notation: { downdiagonalstrike: !0 },
                    body: e[0],
                };
            }),
            bt('\\xcancel', '{body:auto}', null, function(t, e) {
                return {
                    type: 'enclose',
                    strokeColor: 'currentColor',
                    strokeWidth: 1,
                    ...
                    padding: 'auto',
                    shadow: 'auto',
                    notation: { updiagonalstrike: !0, downdiagonalstrike: !0 },
                    body: e[0],
                };
            }),
            J(j, '\\cancel', '\\bcancel', '\\xcancel'),
            (W = 'Styling'),
            bt(
                [
                    '\\tiny',
            ...
            bt('\\fontseries', '{:text}', { allowedInText: !0 }, (t, e) => ({
                fontSeries: gt(e[0]),
            })),
            bt('\\bf', '', { allowedInText: !0 }, (t, e) => ({
                fontSeries: 'b',
            })),
            bt('\\bm', '{:math*}', { allowedInText: !0 }, (t, e) => ({
                fontSeries: 'b',
            })),
            bt('\\bold', '', { allowedInText: !0 }, (t, e) => ({
                mode: 'math',
                fontSeries: 'b',
            })),
            bt(
                ...
                '{:math*}',
                { allowedInText: !0 },
                (t, e) => ({ mode: 'math', fontSeries: 'b', fontShape: 'n' })
            ),
            bt('\\bfseries', '', { allowedInText: !0 }, (t, e) => ({
                fontSeries: 'b',
            })),
            bt('\\textbf', '{:text*}', { allowedInText: !0 }, (t, e) => ({
                fontSeries: 'b',
            })),
            bt('\\mathmd', '{:math*}', { allowedInText: !0 }, (t, e) => ({
                mode: 'math',
                fontSeries: 'm',
                fontShape: 'n',
            })),
            bt('\\mdseries', '', { allowedInText: !0 }, (t, e) => ({
                fontSeries: 'm',
            })),
            bt('\\textmd', '{:math*}', { allowedInText: !0 }, (t, e) => ({
                fontSeries: 'm',
            })),
            bt('\\fontshape', '{:text}', { allowedInText: !0 }, (t, e) => ({
                fontShape: gt(e[0]),
            })),
            bt('\\it', '', { allowedInText: !0 }, (t, e) => ({
                fontShape: 'it',
            })),
            bt('\\mathit', '{:math*}', { allowedInText: !0 }, (t, e) => ({
                mode: 'math',
                fontSeries: 'm',
                fontShape: 'it',
            })),
            bt('\\upshape', '', { allowedInText: !0 }, (t, e) => ({
                fontShape: 'n',
            })),
            bt('\\textup', '{:text*}', { allowedInText: !0 }, (t, e) => ({
                fontShape: 'n',
            })),
            bt('\\textit', '{:text*}', { allowedInText: !0 }, (t, e) => ({
                fontShape: 'it',
            })),
            bt('\\slshape', '', { allowedInText: !0 }, (t, e) => ({
                fontShape: 'sl',
            })),
            bt('\\textsl', '{:text*}', { allowedInText: !0 }, (t, e) => ({
                fontShape: 'sl',
            })),
            bt('\\scshape', '', { allowedInText: !0 }, (t, e) => ({
                mode: 'text',
                fontShape: 'sc',
            })),
            bt('\\textsc', '{:text*}', { allowedInText: !0 }, (t, e) => ({
                fontShape: 'sc',
            })),
            bt('\\fontfamily', '{:text}', { allowedInText: !0 }, (t, e) => ({
                fontFamily: gt(e[0]),
            })),
            bt('\\mathrm', '{:math*}', { allowedInText: !0 }, (t, e) => ({
                mode: 'math',
                fontFamily: 'cmr',
                fontSeries: 'm',
                fontShape: 'n',
            })),
            bt('\\rmfamily', '', { allowedInText: !0 }, (t, e) => ({
                fontFamily: 'cmr',
            })),
            bt('\\textrm', '{:text*}', { allowedInText: !0 }, (t, e) => ({
                fontFamily: 'cmr',
            })),
            bt('\\mathsf', '{:math*}', { allowedInText: !0 }, (t, e) => ({
                mode: 'math',
                baseFontFamily: 'cmss',
                fontSeries: 'm',
                fontShape: 'n',
            })),
            bt('\\sffamily', '', { allowedInText: !0 }, (t, e) => ({
                fontFamily: 'cmss',
            })),
            bt('\\textsf', '{:text*}', { allowedInText: !0 }, (t, e) => ({
                fontFamily: 'cmss',
            })),
            bt('\\mathtt', '{:math*}', { allowedInText: !0 }, (t, e) => ({
                mode: 'math',
                baseFontFamily: 'cmtt',
                fontSeries: 'm',
                fontShape: 'n',
            })),
            bt('\\ttfamily', '', { allowedInText: !0 }, (t, e) => ({
                fontFamily: 'cmtt',
            })),
            bt('\\texttt', '{:text*}', { allowedInText: !0 }, (t, e) => ({
                fontFamily: 'cmtt',
            })),
            bt(
                ['\\Bbb', '\\mathbb'],
                '{:math*}',
                { allowedInText: !0 },
                (t, e) => ({ mode: 'math', baseFontFamily: 'bb' })
            ),
            bt(
                ['\\frak', '\\mathfrak'],
                '{:math*}',
                { allowedInText: !0 },
                (t, e) => ({ baseFontFamily: 'frak' })
            ),
            bt('\\mathcal', '{:math*}', { allowedInText: !0 }, (t, e) => ({
                mode: 'math',
                baseFontFamily: 'cal',
                fontSeries: 'm',
                fontShape: 'n',
            })),
            bt('\\mathscr', '{:math*}', { allowedInText: !0 }, (t, e) => ({
                mode: 'math',
                baseFontFamily: 'scr',
                fontSeries: 'm',
                fontShape: 'n',
            ...
            J(G, '\\mathtt'),
            J(G, '\\boldsymbol'),
            bt('\\textnormal', '{:text*}', { allowedInText: !0 }, (t, e) => ({
                fontFamily: 'cmr',
                fontShape: 'n',
                fontSeries: 'n',
            })),
            bt('\\mbox', '{:text*}', null, (t, e) => ({ fontFamily: 'cmr' })),
            bt('\\text', '{:text*}', { allowedInText: !0 }, (t, e) => ({})),
            bt(
                '\\class',
            ...
            bt(
                ...
                { allowedInText: !0 },
                (t, e) => ({ cssId: gt(e[0]), body: e[1], type: 'group' })
            ),
            bt('\\em', '', { allowedInText: !0 }, (t, e) => ({
                cssClass: 'ML__emph',
                type: 'group',
            })),
            bt('\\emph', '{:auto}', { allowedInText: !0 }, (t, e) => ({
                cssClass: 'ML__emph',
                body: e[0],
                type: 'group',
                skipBoundary: !0,
            ...
            J(49, '\\em'),
            (W = 'Operators'),
            bt('\\sqrt', '[index:auto]{radicand:auto}', null, function(t, e) {
                return { type: 'surd', body: e[1], index: e[0] };
            }),
            J(Z, '\\sqrt'),
            (W = 'Fractions'),
            bt(
                ...
                function(t, e) {
                    ...
                    switch (t) {
                        case '\\dfrac':
                        case '\\dbinom':
                            i.mathstyle = 'displaystyle';
                            break;
                        case '\\tfrac':
                        case '\\tbinom':
                            i.mathstyle = 'textstyle';
                    }
                    return '\\cfrac' === t && (i.continuousFraction = !0), i;
                }
            ),
            bt(['\\over', '\\atop', '\\choose'], '', { infix: !0 }, function(
                t,
                e
            ) {
                const i = e[0],
            ...
            J(G, '\\atopwithdelims'),
            (W = 'Fractions'),
            bt('\\pdiff', '{numerator}{denominator}', null, function(t, e) {
                return {
                    type: 'genfrac',
                    numer: e[0],
                    denom: e[1],
            ...
            J(Z, '\\sum', '\\prod', '\\bigcap', '\\bigcup', '\\int'),
            J(G, '\\bigoplus', '\\smallint', '\\iint', '\\oint'),
            J('RARE', '\\bigwedge', '\\bigvee'),
            J(756, '\\coprod'),
            J(723, '\\bigsqcup'),
            J(1241, '\\bigotimes'),
            J(150, '\\bigodot'),
            ...
            Y('\\&', '', lt, '&', 'RARE'),
            Y('\\clubsuit', '', lt, '♣', 172),
            Y('\\heartsuit', '', lt, '♡', 'ARCANE'),
            Y('\\spadesuit', '', lt, '♠', 'ARCANE'),
            Y('\\diamondsuit', '', lt, '♢', j),
            Y('\\differencedelta', '', ht, '∆', G),
            (W = 'Letters and Letter Like Forms'),
            bt('\\unicode', '{charcode:number}', null, function(t, e) {
                let i = parseInt(e[0]);
                return (
                    isFinite(i) || (i = 10067),
                    { type: 'mord', body: String.fromCodePoint(i) }
                );
            }),
            Y('\\backslash', '', lt, '\\'),
            Y('?', '', lt, '?'),
            ...
            Y('\\hbar', '', lt, 'ℏ', G),
            Y('\\hslash', nt, lt, 'ℏ', G),
            Y('\\differentialD', 'cmr', lt, 'd'),
            Y('\\rd', 'cmr', lt, 'd'),
            Y('\\capitalDifferentialD', 'cmr', lt, 'D'),
            Y('\\rD', 'cmr', lt, 'D'),
            Y('\\exponentialE', 'cmr', lt, 'e'),
            Y('\\Finv', nt, lt, 'Ⅎ', 3),
            Y('\\Game', nt, lt, '⅁', 1),
            Y('\\wp', '', lt, '℘', 1306),
            Y('\\eth', nt, lt, 'ð', 77),
            Y('\\mho', nt, lt, '℧', 138),
            Y('\\Bbbk', nt, lt, 'k'),
            Y('\\doubleStruckCapitalN', 'bb', lt, 'N'),
            Y('\\N', 'bb', lt, 'N'),
            Y('\\doubleStruckCapitalR', 'bb', lt, 'R'),
            Y('\\R', 'bb', lt, 'R'),
            Y('\\doubleStruckCapitalQ', 'bb', lt, 'Q'),
            Y('\\Q', 'bb', lt, 'Q'),
            Y('\\doubleStruckCapitalC', 'bb', lt, 'C'),
            Y('\\C', 'bb', lt, 'C'),
            Y('\\doubleStruckCapitalZ', 'bb', lt, 'Z'),
            Y('\\Z', 'bb', lt, 'Z'),
            Y('\\doubleStruckCapitalP', 'bb', lt, 'P'),
            Y('\\P', 'bb', lt, 'P'),
            Y('\\scriptCapitalE', 'scr', lt, 'E'),
            Y('\\scriptCapitalH', 'scr', lt, 'H'),
            Y('\\scriptCapitalL', 'scr', lt, 'L'),
            Y('\\gothicCapitalC', 'frak', lt, 'C'),
            Y('\\gothicCapitalH', 'frak', lt, 'H'),
            Y('\\gothicCapitalI', 'frak', lt, 'I'),
            Y('\\gothicCapitalR', 'frak', lt, 'R'),
            Y('\\pounds', '', lt, '£', 509),
            Y('\\yen', nt, lt, '¥', 57),
            Y('\\euro', '', lt, '€', 4),
            (W = 'Crosses'),
            ...
            Y('\\maltese', nt, lt, '✠', 24),
            (W = 'Arrows'),
            Y('\\longrightarrow', '', ht, '⟶', Z),
            Y('\\rightarrow', '', ht, '→', Z),
            Y('\\Longrightarrow', '', ht, '⟹', Z),
            Y('\\Rightarrow', '', ht, '⇒', Z),
            Y('\\longmapsto', '', ht, '⟼', G),
            Y('\\mapsto', '', ht, '↦', G),
            Y('\\Longleftrightarrow', '', ht, '⟺', G),
            Y('\\rightleftarrows', nt, ht, '⇄', G),
            Y('\\leftarrow', '', ht, '←', G),
            Y('\\curvearrowleft', nt, ht, '↶', G),
            Y('\\uparrow', '', ht, '↑', G),
            Y('\\downarrow', '', ht, '↓', G),
            Y('\\hookrightarrow', '', ht, '↪', G),
            Y('\\rightharpoonup', '', ht, '⇀', G),
            Y('\\rightleftharpoons', '', ht, '⇌', G),
            Y('\\Leftarrow', '', ht, '⇐', 1695),
            Y('\\longleftrightarrow', '', ht, '⟷', 1599),
            Y('\\longleftarrow', '', ht, '⟵', 878),
            Y('\\Longleftarrow', '', ht, '⟸', 296),
            Y('\\searrow', '', ht, '↘', 1609),
            Y('\\nearrow', '', ht, '↗', 1301),
            Y('\\swarrow', '', ht, '↙', 167),
            Y('\\nwarrow', '', ht, '↖', 108),
            Y('\\Uparrow', '', ht, '⇑', 257),
            Y('\\Downarrow', '', ht, '⇓', 556),
            Y('\\updownarrow', '', ht, '↕', 192),
            Y('\\Updownarrow', '', ht, '⇕', 161),
            Y('\\hookleftarrow', '', ht, '↩', 115),
            Y('\\leftharpoonup', '', ht, '↼', 93),
            Y('\\leftharpoondown', '', ht, '↽', 42),
            Y('\\rightharpoondown', '', ht, '⇁', 80),
            Y('\\leftrightarrows', nt, ht, '⇆', 765),
            Y('\\dashrightarrow', nt, ht, '⇢', 311),
            Y('\\dashleftarrow', nt, ht, '⇠', 5),
            Y('\\leftleftarrows', nt, ht, '⇇', 8),
            Y('\\Lleftarrow', nt, ht, '⇚', 7),
            Y('\\twoheadleftarrow', nt, ht, '↞', 32),
            Y('\\leftarrowtail', nt, ht, '↢', 25),
            Y('\\looparrowleft', nt, ht, '↫', 6),
            Y('\\leftrightharpoons', nt, ht, '⇋', 205),
            Y('\\circlearrowleft', nt, ht, '↺', 105),
            Y('\\Lsh', nt, ht, '↰', 11),
            Y('\\upuparrows', nt, ht, '⇈', 15),
            Y('\\downharpoonleft', nt, ht, '⇃', 21),
            Y('\\multimap', nt, ht, '⊸', 108),
            Y('\\leftrightsquigarrow', nt, ht, '↭', 31),
            Y('\\twoheadrightarrow', nt, ht, '↠', 835),
            Y('\\rightarrowtail', nt, ht, '↣', 195),
            Y('\\looparrowright', nt, ht, '↬', 37),
            Y('\\curvearrowright', nt, ht, '↷', 209),
            Y('\\circlearrowright', nt, ht, '↻', 63),
            Y('\\Rsh', nt, ht, '↱', 18),
            Y('\\downdownarrows', nt, ht, '⇊', 6),
            Y('\\upharpoonright', nt, ht, '↾', 579),
            Y('\\downharpoonright', nt, ht, '⇂', 39),
            Y('\\rightsquigarrow', nt, ht, '⇝', 674),
            Y('\\leadsto', nt, ht, '⇝', 709),
            Y('\\Rrightarrow', nt, ht, '⇛', 62),
            Y('\\restriction', nt, ht, '↾', 29),
            Y('\\upharpoonleft', nt, ht, '↿', j),
            Y('\\rightrightarrows', nt, ht, '⇉', j),
            (W = 'Negated Arrows'),
            Y('\\nrightarrow', nt, ht, '↛', 324),
            Y('\\nRightarrow', nt, ht, '⇏', 107),
            Y('\\nleftrightarrow', nt, ht, '↮', 36),
            Y('\\nLeftrightarrow', nt, ht, '⇎', 20),
            Y('\\nleftarrow', nt, ht, '↚', 7),
            Y('\\nLeftarrow', nt, ht, '⇍', 5),
            (W = 'Negated Relations'),
            Y('\\nless', nt, ht, '≮', 146),
            ...
            Y('\\nsucceq', nt, ht, '⋡', j),
            Y('\\succnsim', nt, ht, '⋩', 4),
            Y('\\succnapprox', nt, ht, '⪺', j),
            Y('\\ncong', nt, ht, '≆', 128),
            Y('\\nshortparallel', nt, ht, '', 6),
            Y('\\nparallel', nt, ht, '∦', 54),
            Y('\\nVDash', nt, ht, '⊯', 5),
            Y('\\nsupseteqq', nt, ht, '', 1),
            Y('\\supsetneq', nt, ht, '⊋', 286),
            Y('\\varsupsetneq', nt, ht, '', 2),
            Y('\\supsetneqq', nt, ht, '⫌', 49),
            Y('\\varsupsetneqq', nt, ht, '', 3),
            Y('\\nVdash', nt, ht, '⊮', 179),
            Y('\\precneqq', nt, ht, '⪵', 11),
            Y('\\succneqq', nt, ht, '⪶', 3),
            Y('\\nsubseteqq', nt, ht, '', 16),
            (W = 'Various'),
            Y('\\checkmark', nt, lt, '✓', 1025),
            Y('\\diagup', nt, lt, '╱', 440),
            Y('\\diagdown', nt, lt, '╲', 175),
            Y('\\measuredangle', nt, lt, '∡', 271),
            Y('\\sphericalangle', nt, lt, '∢', 156),
            Y('\\backprime', nt, lt, '‵', 104),
            Y('\\backdoubleprime', nt, lt, '‶', j),
            (W = 'Shapes'),
            Y('\\ast', '', ct, '∗', Z),
            Y('\\star', '', ct, '⋆', G),
            Y('\\diamond', '', ct, '⋄', 1356),
            ...
            Y('[', '', dt, '['),
            Y(']', '', pt, ']'),
            Y('\\ulcorner', nt, dt, '┌', 296),
            Y('\\urcorner', nt, pt, '┐', 310),
            Y('\\llcorner', nt, dt, '└', 137),
            Y('\\lrcorner', nt, pt, '┘', 199),
            Y('\\lgroup', '', dt, '⟮', 24),
            Y('\\rgroup', '', pt, '⟯', 24),
            Y('\\lmoustache', '', dt, '⎰', j),
            Y('\\rmoustache', '', pt, '⎱', j),
            bt(['\\middle'], '{:delim}', null, function(t, e) {
                return { type: 'delim', delim: e[0] };
            }),
            (W = 'Sizing');
        const xt = {
        ...
        function kt(t) {
            let e = '',
                i = !0;
            for (const s of t)
                'string' == typeof s.body ? (e += s.body) : (i = !1);
            return i ? e : '';
        }
        bt(
            [
            ...
            Y('\\gtrsim', nt, ht, '≳', G),
            Y('\\approx', '', ht, '≈', Z),
            Y('\\approxeq', nt, ht, '≊', 147),
            Y('\\thickapprox', nt, ht, '≈', 377),
            Y('\\lessapprox', nt, ht, '⪅', 146),
            Y('\\gtrapprox', nt, ht, '⪆', 95),
            Y('\\precapprox', nt, ht, '⪷', 50),
            Y('\\succapprox', nt, ht, '⪸', j),
            Y('\\thicksim', nt, ht, '∼', 779),
            Y('\\succsim', nt, ht, '≿', 251),
            Y('\\precsim', nt, ht, '≾', 104),
            Y('\\backsim', nt, ht, '∽', 251),
            Y('\\eqsim', nt, ht, '≂', 62),
            Y('\\backsimeq', nt, ht, '⋍', 91),
            Y('\\simeq', '', ht, '≃', j),
            Y('\\lesssim', nt, ht, '≲', j),
            Y('\\nleq', nt, ht, '≰', 369),
            Y('\\ngeq', nt, ht, '≱', 164),
            Y('\\smallsmile', nt, ht, '⌣', 31),
            Y('\\smallfrown', nt, ht, '⌢', 71),
            Y('\\bowtie', '', ht, '⋈', 558),
            Y('\\asymp', '', ht, '≍', 755),
            Y('\\sqsubseteq', '', ht, '⊑', 1255),
            Y('\\sqsupseteq', '', ht, '⊒', 183),
            Y('\\leqq', nt, ht, '≦', 1356),
            Y('\\eqslantless', nt, ht, '⪕', 15),
            Y('\\lll', nt, ht, '⋘', 157),
            Y('\\lessgtr', nt, ht, '≶', 281),
            Y('\\lesseqgtr', nt, ht, '⋚', 134),
            Y('\\lesseqqgtr', nt, ht, '⪋', j),
            Y('\\risingdotseq', nt, ht, '≓', 8),
            Y('\\fallingdotseq', nt, ht, '≒', 99),
            Y('\\subseteqq', nt, ht, '⫅', 82),
            Y('\\Subset', nt, ht, '⋐'),
            Y('\\sqsubset', nt, ht, '⊏', 309),
            Y('\\preccurlyeq', nt, ht, '≼', 549),
            Y('\\curlyeqprec', nt, ht, '⋞', 14),
            Y('\\vDash', nt, ht, '⊨', 646),
            Y('\\Vvdash', nt, ht, '⊪', 20),
            Y('\\bumpeq', nt, ht, '≏', 13),
            Y('\\Bumpeq', nt, ht, '≎', 12),
            Y('\\geqq', nt, ht, '≧', 972),
            Y('\\eqslantgtr', nt, ht, '⪖', 13),
            Y('\\ggg', nt, ht, '⋙', 127),
            Y('\\gtrless', nt, ht, '≷', 417),
            Y('\\gtreqless', nt, ht, '⋛', 190),
            Y('\\gtreqqless', nt, ht, '⪌', 91),
            Y('\\supseteqq', nt, ht, '⫆', 6),
            Y('\\Supset', nt, ht, '⋑', 34),
            Y('\\sqsupset', nt, ht, '⊐', 71),
            Y('\\succcurlyeq', nt, ht, '≽', 442),
            Y('\\curlyeqsucc', nt, ht, '⋟', 10),
            Y('\\Vdash', nt, ht, '⊩', 276),
            Y('\\shortmid', nt, ht, '∣', 67),
            Y('\\shortparallel', nt, ht, '∥', 17),
            Y('\\between', nt, ht, '≬', 110),
            Y('\\pitchfork', nt, ht, '⋔', 66),
            Y('\\varpropto', nt, ht, '∝', 203),
            Y('\\backepsilon', nt, ht, '∍', 176),
            Y('\\llless', nt, ht, '⋘', j),
            Y('\\gggtr', nt, ht, '⋙', j),
            Y('\\lhd', nt, ct, '⊲', 447),
            Y('\\rhd', nt, ct, '⊳', 338),
            ...
            Y('\\~', '', ht, '~'),
            (W = 'Logic'),
            Y('\\leftrightarrow', '', ht, '↔', Z),
            Y('\\Leftrightarrow', '', ht, '⇔', Z),
            Y('\\to', '', ht, '→', Z),
            Y('\\models', '', ht, '⊨', G),
            Y('\\vdash', '', ht, '⊢', G),
            Y('\\therefore', nt, ht, '∴', 1129),
            Y('\\because', nt, ht, '∵', 388),
            Y('\\implies', '', ht, '⟹', 1858),
            Y('\\gets', '', ht, '←', 150),
            Y('\\dashv', '', ht, '⊣', 299),
            Y('\\impliedby', '', ht, '⟸', j),
            Y('\\biconditional', '', ht, '⟷', j),
            Y('\\roundimplies', '', ht, '⥰', j),
            (W = 'Operators'),
            Y('+', '', ct, '+', Z),
            Y('-', '', ct, '−', Z),
            ...
            Y('\\ltimes', nt, ct, '⋉', 576),
            Y('\\rtimes', nt, ct, '⋊', 946),
            Y('\\leftthreetimes', nt, ct, '⋋', 34),
            Y('\\rightthreetimes', nt, ct, '⋌', 14),
            Y('\\intercal', nt, ct, '⊺', 478),
            Y('\\dotplus', nt, ct, '∔', 81),
            Y('\\centerdot', nt, ct, '⋅', 271),
            Y('\\doublebarwedge', nt, ct, '⩞', 5),
            Y('\\divideontimes', nt, ct, '⋇', 51),
            Y('\\cdot', '', ct, '⋅', j),
            (W = 'Others'),
            Y('\\infty', '', lt, '∞', Z),
            Y('\\prime', '', rt, '′', Z),
            ...
            Y('\\Psi', '', rt, 'Ψ', G),
            Y('\\Omega', '', rt, 'Ω', G),
            Y('\\digamma', nt, rt, 'ϝ', 248),
            (W = 'Others'),
            Y('\\emptyset', '', lt, '∅', Z),
            Y('\\varnothing', nt, lt, '∅', Z),
            (W = 'Set Operators'),
            Y('\\cap', '', ct, '∩', Z),
            Y('\\cup', '', ct, '∪', Z),
            Y('\\setminus', '', ct, '∖', G),
            Y('\\smallsetminus', nt, ct, '∖', 254),
            Y('\\complement', nt, lt, '∁', 200),
            (W = 'Set Relations'),
            Y('\\in', '', ht, '∈', Z),
            Y('\\notin', '', ht, '∉', Z),
            Y('\\not', '', ht, '̸', G),
            ...
            Y('\\subseteq', '', ht, '⊆', Z),
            Y('\\supseteq', '', ht, '⊇', Z),
            Y('\\subsetneq', nt, ht, '⊊', 1945),
            Y('\\varsubsetneq', nt, ht, '', 198),
            Y('\\subsetneqq', nt, ht, '⫋', 314),
            Y('\\varsubsetneqq', nt, ht, '', 55),
            Y('\\nsubset', nt, ht, '⊄', j),
            Y('\\nsupset', nt, ht, '⊅', j),
            Y('\\nsubseteq', nt, ht, '⊈', 950),
            Y('\\nsupseteq', nt, ht, '⊉', 49),
            ...
            bt(
                ...
                { allowedInText: !0 },
                function(t, e) {
                    return { type: 'spacing', width: e[0] || 0 };
                }
            ),
            bt(
                [
                ...
                function(t, e) {
                    const i = {
                        ...
                        body: kt(e[0]) || e[0],
                        captureSelection: !0,
                        baseFontFamily: '\\mathop' === t ? 'math' : '',
                    };
                    return (
                        '\\mathop' === t &&
                            ((i.limits = 'nolimits'), (i.isFunction = !0)),
                        i
                    );
                }
            ),
            bt(
                ...
                function(t, e) {
                    ...
                    return (
                        i.body.forEach(t => {
                            (t.isFunction = !1), (t.autoFontFamily = 'cmr');
                        }),
                        '\\operatorname' === t
                            ? (i.limits = 'nolimits')
                            : '\\operatorname*' === t && (i.limits = 'limits'),
                        i
                    );
                }
            ),
            ...
            Y('\\veebar', nt, ct, '⊻', 43),
            Y('\\nor', nt, ct, '⊻', 7),
            Y('\\curlywedge', nt, ct, '⋏', 58),
            Y('\\curlyvee', nt, ct, '⋎', 57),
            (W = 'Boxes'),
            Y('\\square', nt, lt, '□', G),
            Y('\\Box', nt, lt, '□', G),
            Y('\\blacksquare', nt, lt, '■', 1679),
            Y('\\boxminus', nt, ct, '⊟', 79),
            Y('\\boxplus', nt, ct, '⊞', 276),
            Y('\\boxtimes', nt, ct, '⊠', 457),
            Y('\\boxdot', nt, ct, '⊡', 120),
            (W = 'Circles'),
            Y('\\circ', '', ct, '∘', Z),
            Y('\\bigcirc', '', ct, '◯', 903),
            Y('\\bullet', '', ct, '∙', G),
            Y('\\circleddash', nt, ct, '⊝', G),
            Y('\\circledast', nt, ct, '⊛', 339),
            Y('\\oplus', '', ct, '⊕', G),
            Y('\\ominus', '', ct, '⊖', 1568),
            Y('\\otimes', '', ct, '⊗', G),
            Y('\\odot', '', ct, '⊙', G),
            Y('\\circledcirc', nt, ct, '⊚', 93),
            Y('\\oslash', '', ct, '⊘', 497),
            Y('\\circledS', nt, lt, 'Ⓢ', 31),
            Y('\\circledR', nt, lt, '®', 1329),
            (W = 'Triangles'),
            Y('\\triangle', '', lt, '△', G),
            Y('\\triangleq', nt, ht, '≜', G),
            Y('\\bigtriangleup', '', ct, '△', 1773),
            Y('\\vartriangle', nt, ht, '△', 762),
            Y('\\triangledown', nt, lt, '▽', 520),
            Y('\\bigtriangledown', '', ct, '▽', 661),
            Y('\\triangleleft', '', ct, '◃', 534),
            Y('\\vartriangleleft', nt, ht, '⊲', 281),
            Y('\\trianglelefteq', nt, ht, '⊴', 176),
            Y('\\ntriangleleft', nt, ht, '⋪', 13),
            Y('\\ntrianglelefteq', nt, ht, '⋬', 22),
            Y('\\triangleright', '', ct, '▹', 516),
            Y('\\vartriangleright', nt, ht, '⊳', 209),
            Y('\\trianglerighteq', nt, ht, '⊵', 45),
            Y('\\ntriangleright', nt, ht, '⋫', 15),
            Y('\\ntrianglerighteq', nt, ht, '⋭', 6),
            Y('\\blacktriangle', nt, lt, '▲', 360),
            Y('\\blacktriangledown', nt, lt, '▼', 159),
            Y('\\blacktriangleleft', nt, ht, '◀', 101),
            Y('\\blacktriangleright', nt, ht, '▶', 271),
            (W = 'Others'),
            Y('\\/', '', rt, '/'),
            Y('|', '', 'textord', '∣'),
            (W = 'Big Operators'),
            ...
            Y('"', '', lt, '”'),
            (W = 'Others'),
            bt('\\^', '{:string}', { allowedInText: !0 }, function(t, e) {
                return {
                    type: 'mord',
                    limits: 'nolimits',
                    symbol: !0,
            ...
            bt('\\c', '{:string}', { allowedInText: !0 }, function(t, e) {
                return {
                    type: 'mord',
                    limits: 'nolimits',
                    symbol: !0,
                    isFunction: !1,
                    body: (e[0] && { c: 'ç', C: 'Ç' }[e[0]]) || '',
                    baseFontFamily: 'cmr',
                };
            });
        const vt = {
        ...
        var At = {
            ...
            commandAllowed: function(t, e) {
                return (
                    !(!V[e] || ('text' === t && !V[e].allowedInText)) ||
                    !!{ text: vt, math: H }[t][e]
                );
            },
            unicodeToMathVariant: at,
            mathVariantToUnicode: function(t, e, i) {
                ...
                for (let t = 0; t < st.length; t++)
                    if (
                        ...
                        (!i || st[t].style === i) &&
                        s >= st[t].offset &&
                        s < st[t].offset + st[t].len
                    ) {
                        const e = st[t].start + s - st[t].offset;
                        return String.fromCodePoint(it[e] || e);
                    }
                return t;
            },
            unicodeStringToLatex: function(t, e) {
                let i = '';
                for (const s of e) i += ot(t, s.codePointAt(0));
                return i;
            },
            getInfo: function(t, e, i) {
                if (0 === t.length) return null;
                let s = null;
                if ('\\' === t.charAt(0)) {
                    if (((s = V[t]), s))
                        return 'math' === e || s.allowedInText ? s : null;
                    if (
                        (s ||
                            ('math' === e
                                ? (s = H[t])
                    ...
                    'math' === e ? (s = H[t]) : vt[t] && (s = { value: vt[t] });
                return (
                    !s ||
                        'mord' !== s.type ||
                        ('f' !== s.value &&
            ...
            suggest: function(t) {
                ...
                for (const i in V)
                    Object.prototype.hasOwnProperty.call(V, i) &&
                        i.startsWith(t) &&
                        !V[i].infix &&
                        e.push({ match: i, frequency: V[i].frequency });
                for (const i in H)
                    Object.prototype.hasOwnProperty.call(H, i) &&
                        i.startsWith(t) &&
                        e.push({ match: i, frequency: H[i].frequency });
                return (
                    e.sort((t, e) =>
        ...
        function Tt(t, e, i, s, a, o) {
            ...
            return (
                s &&
                    r.setTop(
                        (1 - a.mathstyle.sizeMultiplier) *
                            a.mathstyle.metrics.axisHeight
                    ),
                r.setStyle('color', a.color),
                'number' == typeof a.opacity &&
                    r.setStyle('opacity', a.opacity),
                r
            );
        }
        function Lt(t, e) {
        ...
        function Ft(t, e, i, s, a, o) {
            ...
            const k = p + y + b,
                v = Math.ceil((i - k) / (x * f)),
                w = k + v * x * f;
            let S = a.mathstyle.metrics.axisHeight;
        ...
        function Bt(t, e, i, s, a, o) {
            ...
            const r = (function(t, e, i, s) {
                for (
                    ...
                    o < i.length && 'stack' !== i[o].type;
                    o++
                ) {
                    const s = m.getCharacterMetrics(
                        t,
                        'small' === (a = i[o]).type
                            ? 'Main-Regular'
                            : 'large' === a.type
                    ...
                    if (s.defaultMetrics)
                        return { type: 'small', mathstyle: M.SCRIPT };
                    let n = s.height + s.depth;
                    if (
                        ('small' === i[o].type &&
                            (n *= i[o].mathstyle.sizeMultiplier),
                        n > e)
                    )
                        return i[o];
                }
        ...
        class Zt {
                ...
                return (
                    Array.isArray(this.body) &&
                        ...
                        ('first' !== this.body[0].type
                            ...
                            : this.body[1] &&
                              (t = this.body[1].getInitialBaseElement())),
                    t
                );
            }
            getFinalBaseElement() {
            ...
            isCharacterBox() {
                ...
                return /minner|mbin|mrel|mpunct|mopen|mclose|textord/.test(
                    t.type
                );
            }
            forEach(t) {
                ...
                if (this.subscript)
                    for (const e of this.subscript) e && e.forEach(t);
                if (this.overscript)
                    for (const e of this.overscript) e && e.forEach(t);
                if (this.underscript)
                ...
                if (this.array)
                    for (const e of this.array)
                        for (const i of e) for (const e of i) e.forEach(t);
            }
            filter(t) {
                let e = [];
                t(this) && e.push(this);
                for (const i of [
                    ...
                    if (Array.isArray(this[i]))
                        for (const s of this[i])
                            s && (e = e.concat(s.filter(t)));
                if (Array.isArray(this.array))
                    for (const i of this.array)
                        for (const s of i) s && (e = e.concat(s.filter(t)));
                return e;
            }
            decomposeGroup(t) {
            ...
            decomposeArray(t) {
                let e = this.colFormat;
                e && 0 === e.length && (e = [{ align: 'l' }]),
                    e ||
                        (e = [
                            { align: 'l' },
                            { align: 'l' },
                ...
                const i = [];
                let s = 0;
                for (const t of e) t.align && s++;
                for (const t of this.array) {
                    let e = 0;
                    for (; e < t.length; ) {
                        const a = [],
                            o = Math.min(t.length, e + s);
                        for (; e < o; ) a.push(t[e++]);
                        i.push(a);
                    }
                }
                1 === i[i.length - 1].length &&
                    ...
                    i.pop();
                const a = M.toMathstyle(this.mathstyle) || t.mathstyle,
                    o = (this.arraystretch || 1) * h.baselineskip,
                    n = 0.7 * o,
                    r = 0.3 * o;
                let l = 0,
                    c = 0;
                ...
                const m = l / 2 + a.metrics.axisHeight,
                    u = [];
                for (let e = 0; e < c; e++) {
                    const i = [];
                    for (const t of d) {
                ...
                for (const i of e) {
                    ...
                    if (i.align && b < u.length)
                        ...
                        e.setStyle('height', l, 'em'),
                            e.setStyle(
                                'margin-top',
                                3 * t.mathstyle.metrics.axisHeight - m,
                                'em'
                            ),
                            e.setStyle('vertical-align', 'top');
                        let i = 0;
                        y
                            ? (i = h.doubleRuleSep - h.arrayrulewidth)
                            : g && (i = h.arraycolsep - h.arrayrulewidth),
                            e.setLeft(i, 'em'),
                            f.push(e),
                            (g = !1),
                            (y = !0),
            ...
            decomposeGenfrac(t) {
                ...
                const l = Ht(n, t.mathstyle.adjustTo(r)),
                    c = this.hasBarLine
                        ...
                        : 0;
                let d, p, m;
                e.size === M.DISPLAY.size
                    ? ((d = e.metrics.num1),
                      (p = c > 0 ? 3 * c : 7 * h.defaultRuleThickness),
                      (m = e.metrics.denom1))
                    : (c > 0
                          ? ((d = e.metrics.num2), (p = c))
                          : ((d = e.metrics.num3),
                            (p = 3 * h.defaultRuleThickness)),
                      (m = e.metrics.denom2));
                const u = o ? o.depth : 0,
                    f = l ? l.height : 0;
                let g;
                ...
                (g.classes += ' mfrac'),
                    ...
                    (g.depth *= e.sizeMultiplier / t.mathstyle.sizeMultiplier);
                const y =
                        e.size === M.DISPLAY.size
                            ? e.metrics.delim1
                            : e.metrics.delim2,
            ...
            decomposeRule(t) {
                ...
                const a = this.width / e.sizeMultiplier,
                    o = this.height / e.sizeMultiplier;
                return (
                    i.setStyle('border-right-width', a, 'em'),
                    i.setStyle('border-top-width', o, 'em'),
                    i.setStyle('margin-top', -(o - s), 'em'),
                    i.setStyle('border-color', t.color),
                    (i.width = a),
                    (i.height = o + s),
                    (i.depth = -s),
                    i
            ...
            decomposeOp(t) {
                ...
                if (this.symbol) {
                    ...
                    (i = N.makeSymbol(
                        ...
                        (a =
                            (i.height - i.depth) / 2 -
                            e.metrics.axisHeight * e.sizeMultiplier),
                        (o = i.italic),
                        this.bind(t, i);
                } else
                    Array.isArray(this.body)
                ...
                if (this.superscript || this.subscript) {
                    ...
                    return this.alwaysHandleSupSub ||
                        'limits' === s ||
                        ('auto' === s && e.size === M.DISPLAY.size)
                        ? this.attachLimits(t, i, a, o)
                        : this.attachSupsub(t, i, 'mop');
                }
            ...
            decomposeBox(t) {
                ...
                i.setStyle('height', e.height + e.depth + 2 * s, 'em'),
                    0 !== s
                        ? i.setStyle('width', 'calc(100% + ' + 2 * s + 'em)')
                        : i.setStyle('width', '100%'),
                    i.setStyle('top', -s, 'em'),
                    i.setStyle('left', -s, 'em'),
                    i.setStyle('z-index', '-1'),
                    this.backgroundcolor &&
                        i.setStyle('background-color', this.backgroundcolor),
                    this.framecolor &&
                        i.setStyle(
                            'border',
                            h.fboxrule + 'em solid ' + this.framecolor
                        ),
                    this.border && i.setStyle('border', this.border),
            ...
            decomposeEnclose(t) {
                ...
                e.setStyle('padding', i, 'em'),
                    e.setStyle('display', 'inline-block'),
                    e.setStyle('height', e.height + e.depth, 'em'),
                    e.setStyle('left', -i, 'em'),
                    this.backgroundcolor &&
                        'transparent' !== this.backgroundcolor &&
                        e.setStyle('background-color', this.backgroundcolor);
                let s = '';
                if (
                    (this.notation.box &&
                        e.setStyle('border', this.borderStyle),
                    this.notation.actuarial &&
                        (e.setStyle('border-top', this.borderStyle),
                        e.setStyle('border-right', this.borderStyle)),
                    this.notation.madruwb &&
                        (e.setStyle('border-bottom', this.borderStyle),
                        e.setStyle('border-right', this.borderStyle)),
                    ...
                    this.notation.circle &&
                        (e.setStyle('border-radius', '50%'),
                        e.setStyle('border', this.borderStyle)),
                    this.notation.top &&
                        e.setStyle('border-top', this.borderStyle),
                    this.notation.left &&
                        e.setStyle('border-left', this.borderStyle),
                    this.notation.right &&
                        e.setStyle('border-right', this.borderStyle),
            ...
            decompose(t, e) {
                ...
                if (
                    !this.type ||
                    /mord|minner|mbin|mrel|mpunct|mopen|mclose|textord/.test(
                        this.type
                    )
                )
                    (i =
                ...
                else if ('array' === this.type) i = this.decomposeArray(t);
                else if ('genfrac' === this.type) i = this.decomposeGenfrac(t);
                else if ('surd' === this.type) i = this.decomposeSurd(t);
                else if ('accent' === this.type) i = this.decomposeAccent(t);
                    ...
                    i = this.decomposeOverunder(t);
                else if ('overlap' === this.type) i = this.decomposeOverlap(t);
                ...
                else if ('spacing' === this.type)
                    if ('​' === this.body) i = this.makeSpan(t, '​');
                    else if (' ' === this.body)
                        i =
                            'math' === this.mode
                                ? this.makeSpan(t, ' ')
                    ...
                    'mathstyle' === this.type
                        ...
                        : 'box' === this.type
                        ? (i = this.decomposeBox(t))
                        : 'enclose' === this.type
                        ? (i = this.decomposeEnclose(t))
                        : 'command' === this.type || 'error' === this.type
                        ? ((i = this.makeSpan(t, this.body)),
                          (i.classes = ''),
                          this.error && (i.classes += ' ML__error'),
                          this.suggestion && (i.classes += ' ML__suggestion'))
                        : 'placeholder' === this.type
                        ? (i = this.makeSpan(t, '⬚'))
                        : 'first' === this.type && (i = this.makeSpan(t, '​'));
                if (!i) return i;
                if (
                    (this.caret &&
                        'styling' !== this.type &&
                    ...
                    if (Array.isArray(i)) {
                        ...
                        i[i.length - 1] = this.attachSupsub(t, e, e.type);
                    } else i = [this.attachSupsub(t, i, i.type)];
                ...
                this.isCharacterBox() ||
                    ...
                    (n =
                        s === M.DISPLAY
                            ...
                            ? s.metrics.sup3
                            : s.metrics.sup2);
                const c = M.TEXT.sizeMultiplier * s.sizeMultiplier,
                    d = 0.5 / h.ptPerEm / c;
                let p = null;
                if (o && a) {
                ...
                return (
                    'first' !== this.type &&
                        ...
                        ((this.id = (function(t) {
                            let e;
                            return (
                                'boolean' == typeof t.generateID && t.generateID
                                    ? (e =
                                          Date.now()
                                              .toString(36)
                                              .slice(-2) +
                                    ...
                                    : 'object' == typeof t.generateID &&
                                      ((e = t.generateID.overrideID
                                          ? t.generateID.overrideID
                                          : t.generateID.seed.toString(36)),
                                      (t.generateID.seed += 1)),
                                e
                            );
                        })(t)),
        ...
        function Yt(t, e, i, s, a, o, n) {
            ...
            a && (r = Math.max(h.bigOpSpacing1, h.bigOpSpacing3 - a.depth)),
                o &&
                    (l = Math.max(h.bigOpSpacing2, h.bigOpSpacing4 - o.height));
            let c = null;
            if (o && a) {
                const n =
                    h.bigOpSpacing5 +
        ...
        function Qt(t, e) {
            ...
            const a = !t.generateID || !t.generateID.groupNumbers;
            let o = [];
            if (Array.isArray(e)) {
                ...
                if (1 === e.length)
                    ...
                    for (let p = 0; p < e.length; p++) {
                        'mbin' === e[p].type &&
                            (/first|none|mrel|mpunct|mopen|mbin|mop/.test(n) ||
                                /none|mrel|mpunct|mclose/.test(r)) &&
                            (e[p].type = 'mord'),
                            ('​' === e[p].body &&
                                (e[p].superscript || e[p].subscript)) ||
                                (d = null),
                            t.generateID.groupNumbers &&
                                c &&
                                ((h && i(e[p])) || (!h && s(e[p]))) &&
                                (t.generateID.overrideID = c);
                        const m = e[p].decompose(t, d);
                        if (
                            (t.generateID && (t.generateID.overrideID = null),
                            m)
                        ) {
                            const n = [].concat.apply([], m);
                            (d = n),
                                t.generateID &&
                                    t.generateID.groupNumbers &&
                                    ((i(e[p]) || s(e[p])) &&
                                ...
                                a && e[p].isSelected
                                    ? ((l = l.concat(n)),
                                      l.forEach(t => t.selected(!0)))
                                    : (l.length > 0 &&
                                          ((o = [...o, ...l]), (l = [])),
                                      (o = o.concat(n)));
                        }
                        (n = e[p].getFinalBaseElement().type),
                            (r = e[p + 1]
                                ? e[p + 1].getInitialBaseElement().type
                                : 'none');
                    }
                    l.length > 0 && ((o = [...o, ...l]), (l = []));
                }
                ...
                e &&
                    ((o = e.decompose(t)),
                    o && a && e.isSelected && o.forEach(t => t.selected(!0)));
            if (!o || 0 === o.length) return null;
            if (t.mathstyle !== t.parentMathstyle) {
                const e =
                    t.mathstyle.sizeMultiplier /
                    t.parentMathstyle.sizeMultiplier;
        ...
        var se = function(t) {
                ...
                let i,
                    ...
                    r = 255,
                    l = -1;
                const c = e.length > 0 && '-' === e[0].charAt(0);
                c && (e[0] = e[0].slice(1));
                for (let t = 0; t < e.length; t++) {
                    (i = o), (s = n), (a = r);
                    ...
                    if (d && d[1] && d[2] && d[3])
                        (o = Math.max(0, Math.min(255, parseInt(d[1], 16)))),
                            (n = Math.max(
                                0,
                                Math.min(255, parseInt(d[2], 16))
                            )),
                            (r = Math.max(
                                0,
                                Math.min(255, parseInt(d[3], 16))
                            ));
                    else if (((d = h.match(/^#([0-9a-f]{3})$/i)), d && d[1])) {
                        const t = parseInt(d[1][0], 16),
                            e = parseInt(d[1][1], 16),
                            i = parseInt(d[1][2], 16);
                        (o = Math.max(0, Math.min(255, 16 * t + t))),
                            (n = Math.max(0, Math.min(255, 16 * e + e))),
                            (r = Math.max(0, Math.min(255, 16 * i + i)));
                    } else {
                        if (
                            ((d = h.match(
                            ...
                            return null;
                        (o = Math.max(0, Math.min(255, parseInt(d[1])))),
                            (n = Math.max(0, Math.min(255, parseInt(d[2])))),
                            (r = Math.max(0, Math.min(255, parseInt(d[3]))));
                    }
                    l >= 0 &&
                        ((o = (1 - l) * o + l * i),
                        (n = (1 - l) * n + l * s),
                        ...
                        t + 1 < e.length &&
                            (l =
                                Math.max(0, Math.min(100, parseInt(e[++t]))) /
                                100);
                }
                return (
                    l >= 0 &&
        ...
        class le {
            ...
            hasLiteralPattern(t) {
                return (
                    ...
                    t.test(this.tokens[this.index].value)
                );
            }
            hasCommand(t) {
                const e = this.index;
            ...
            parseFiller() {
                let t = !1,
                    e = !1;
                do {
                    const i = this.skipWhitespace(),
                        s = this.parseCommand('relax');
                    (t = t || i || s), (e = !i && !s);
                } while (!e);
                return t;
            }
            parseKeyword(t) {
                ...
                for (; !i; ) {
                    const e = this.get();
                    'literal' === e.type && (s += e.value),
                        (i =
                            this.end() ||
                            'literal' !== e.type ||
                            s.length >= t.length);
                }
                const a = t.toUpperCase() === s.toUpperCase();
            ...
            scanNumber(t) {
                ...
                this.parseLiteral("'")
                    ...
                    : (this.parseLiteral('"') || this.parseLiteral('x')) &&
                      ((i = 16), (s = /[0-9A-F]/), (t = !0));
                let a = '';
                for (; this.hasLiteralPattern(s); ) a += this.get().value;
                if (!t && (this.parseLiteral('.') || this.parseLiteral(',')))
                    for (a += '.'; this.hasLiteralPattern(s); )
                        a += this.get().value;
                const o = t ? parseInt(a, i) : parseFloat(a);
                return e ? -o : o;
            }
            scanDimen() {
            ...
            scanColspec() {
                ...
                for (
                    ;
                    !this.end() && !this.hasToken('}') && !this.hasLiteral(']');
            ...
            scanModeShift() {
                ...
                const i = this.swapParseMode('math');
                return (
                    (e.body = this.scanImplicitGroup(e => e.type === t)),
                    this.parseToken(t),
                    this.swapParseMode(i),
                ...
                if (e && e.params)
                    for (const t of e.params)
                        if (t.optional) {
                            ...
                            i.push(e);
                        } else i.push(this.scanArg(t.type));
                ...
                for (; !this.end() && !t(this.peek()); )
                    if (
                        ...
                        this.hasInfixCommand() && !i
                            ? ((i = this.get()), (s = this.swapMathList([])))
                            : this.parseAtom();
                let o;
                if (i) {
            ...
            parseSupSub() {
                ...
                for (
                    ...
                    if (
                        (this.hasLiteral('^')
                            ? (e = 'superscript')
                            : this.hasLiteral('_') && (e = 'subscript'),
                        this.parseLiteral('^') || this.parseLiteral('_'))
                    ) {
                        const i = this.scanArg();
                        if (i) {
                            const s = this.lastMathAtom();
                            (s[e] = s[e] || []),
                                (s[e] = s[e].concat(i)),
                                (t = !0);
                        }
            ...
            scanOptionalArg(t) {
                ...
                for (; !this.end() && !this.parseLiteral(']'); )
                    if ('string' === t) s = this.scanString();
                    else if ('number' === t) s = this.scanNumber();
                    else if ('dimen' === t) s = this.scanDimen();
                    else if ('skip' === t) s = this.scanSkip();
                    else if ('colspec' === t) s = this.scanColspec();
                    else if ('color' === t) s = this.scanColor() || '#ffffff';
                    else if ('bbox' === t) {
                        ...
                        for (const e of t) {
                            ...
                            if (t) (s = s || {}), (s.backgroundcolor = t);
                                ...
                                if (t)
                                    (s = s || {}),
                                        (s.padding = m.toEm(t[1], t[2]));
                                else {
                                    const t = e.match(/^\s*border\s*:\s*(.*)/);
                                    t && ((s = s || {}), (s.border = t[1]));
                                }
                            }
                        }
            ...
            scanArg(t) {
                ...
                if (
                    ...
                    if (/^(math|text)$/.test(t)) {
                        const e = this.parseMode;
                        this.parseMode = t;
                        const i = this.scanToken();
                        return (
                            (this.parseMode = e),
                            Array.isArray(i) ? i : i ? [i] : null
                        );
                    }
                }
                if (this.hasToken('#')) {
                ...
                if ('space' === t.type)
                    ...
                    if ('placeholder' === t.value)
                        ...
                        let a = '',
                            o = '';
                        if (i && i.params)
                            for (const t of i.params)
                                if (t.optional) {
                                    const e = this.scanOptionalArg(t.type);
                                    s.push(e);
                                } else if (t.type.endsWith('*'))
                                    o = t.type.slice(0, -1);
                                else {
                                    const e = this.scanArg(t.type);
                                    if (
                                        (e &&
                                            1 === e.length &&
                                            'placeholder' === e[0].type &&
                                            t.placeholder &&
                                            (e[0].value = t.placeholder),
                                        e)
                                    )
                                        s.push(e);
                                        ...
                                        (e.captureSelection = !0), s.push([e]);
                                    } else s.push(this.placeholder());
                                    'math' !== t.type &&
                                        'string' == typeof e &&
                                        (a += e);
                                }
                            ...
                            if (i.parse) {
                                ...
                                if (a.type)
                                    ...
                                    if (
                                        ...
                                        const t = this.style;
                                        (this.style = { ...this.style, ...a }),
                                            (e = this.scanArg(o)),
                                            (this.style = t);
                                    } else this.style = { ...this.style, ...a };
                                    this.parseMode = t;
                                }
                            } else {
                                const s = { ...this.style };
                                i.baseFontFamily &&
                                    ...
                                    i.skipBoundary && (e.skipBoundary = !0);
                            }
                            if (
                                e &&
                    ...
                    if (
                        ...
                        i && i.isFunction && this.smartFence)
                    ) {
                        const t = this.scanSmartFence();
                        t && (e = [e, t]);
                    }
                } else if ('#' === t.type)
                    if ('?' === t.value) e = this.placeholder();
                    else if (this.args)
                        if (
                            ((e = this.args[t.value] || null),
            ...
            scanMacro(t) {
                ...
                'string' == typeof this.macros[t]
                    ? ((i = this.macros[t]),
                      ...
                      /(^|[^\\])#9/.test(i) && (s = 9))
                    : ((i = this.macros[t].def),
                      (s = this.macros[t].args || 0));
                for (let t = 1; t <= s; t++) e[t] = this.scanArg();
                this.args &&
        ...
        function pe(t) {
            ...
            for (const t of s) {
                const i = t.match(/([^:]*):(.*)/);
                i && e.path.push({ relation: i[1], offset: parseInt(i[2]) });
            }
            return e;
        }
        var me = {
            ...
            pathDistance: function(t, e) {
                ...
                for (; !a; )
                    (s += 1),
                        (a = s >= t.length || s >= e.length),
                        (a =
                            a ||
                            !(
                                t[s].relation === e[s].relation &&
                                t[s].offset === e[s].offset
                            ));
                return (
                    (i =
            ...
            pathCommonAncestor: function(t, e) {
                const i = [],
                    s = Math.min(t.length - 1, e.length - 1);
                let a = 0;
                for (
                    ;
                    a <= s &&
        ...
        const ue = {
                ...
                'command:Esc': ['complete', { discard: !0 }],
                'command:Tab': ['complete', { acceptSuggestion: !0 }],
                'command:Return': 'complete',
                'command:Enter': 'complete',
                'command:Shift-Esc': ['complete', { discard: !0 }],
            ...
            ge = {
                ...
                Ω: '\\omega',
                forall: '\\forall',
                exists: { mode: 'math', value: '\\exists' },
                '!exists': { mode: 'math', value: '\\nexists' },
                ':.': { mode: 'math', value: '\\therefore' },
                liminf: '\\operatorname*{lim~inf}_{#?}',
                limsup: '\\operatorname*{lim~sup}_{#?}',
                argmin: '\\operatorname*{arg~min}_{#?}',
                argmax: '\\operatorname*{arg~max}_{#?}',
                det: '\\det',
                mod: { mode: 'math', value: '\\mod' },
                max: { mode: 'math', value: '\\max' },
                min: { mode: 'math', value: '\\min' },
                erf: '\\operatorname{erf}',
                erfc: '\\operatorname{erfc}',
                bessel: { mode: 'math', value: '\\operatorname{bessel}' },
                mean: { mode: 'math', value: '\\operatorname{mean}' },
                median: { mode: 'math', value: '\\operatorname{median}' },
                fft: { mode: 'math', value: '\\operatorname{fft}' },
                lcm: { mode: 'math', value: '\\operatorname{lcm}' },
                gcd: { mode: 'math', value: '\\operatorname{gcd}' },
                randomReal: '\\operatorname{randomReal}',
                randomInteger: '\\operatorname{randomInteger}',
                Re: { mode: 'math', value: '\\operatorname{Re}' },
                Im: { mode: 'math', value: '\\operatorname{Im}' },
                mm: {
                    mode: 'math',
                    after: 'nothing+digit',
        ...
        function ye(t, e, i) {
            ...
            let s = !1,
                ...
                y = e[e.length - 1],
                b = e.length - 1;
            for (; y && /msubsup|placeholder/.test(y.type); )
                (b -= 1), (y = e[b]);
            return (
                (s = !y || 'first' === y.type),
                y &&
                    ...
                    (g = 'space' === y.type)),
                void 0 !== i.after
                    ? (/nothing/.test(i.after) && s) ||
                      (/letter/.test(i.after) && a) ||
                      (/digit/.test(i.after) && o) ||
                      (/function/.test(i.after) && n) ||
                      (/frac/.test(i.after) && r) ||
                      (/surd/.test(i.after) && l) ||
                      (/binop/.test(i.after) && c) ||
                      (/relop/.test(i.after) && h) ||
                      (/punct/.test(i.after) && d) ||
                      (/array/.test(i.after) && p) ||
                      (/openfence/.test(i.after) && m) ||
                      (/closefence/.test(i.after) && u) ||
                      (/text/.test(i.after) && f) ||
                      (/space/.test(i.after) && g)
                        ? i.value
                        : null
                    : i.value
            );
            ...
            for (const s of t) {
                ...
                if (t) {
                    ...
                    for (const t of a)
                        !s &&
                            o.length > 0 &&
                            (o += '<span class="ML__shortcut-join">+</span>'),
                            'Key' === t.substr(0, 3)
                                ? (o += t.substr(3, 1))
                                : 'Digit' === t.substr(0, 5)
                                ? (o += t.substr(5, 1))
                    ...
                    i.length > 0 && (i += e || ' or '), (i += o);
                }
            }
            return i;
        }
        var ve = {
            KEYBOARD_SHORTCUTS: ue,
            INLINE_SHORTCUTS: ge,
            stringify: ke,
        ...
        function Te(t, e, i) {
            ...
            let s,
                a = [];
            for (let o of t)
                o && o.length > 0 && 'first' === o[0].type && (o = o.slice(1)),
                    o &&
                        o.length > 0 &&
                        (s
                            ? a.push(s)
        ...
        function Ee(t, e) {
            ...
            return qe(
                (t = (t = (t = (t = (t = (t = t.replace(
                    ...
                    /([^\\])sinx/g,
                    '$1\\sin x'
                )).replace(/([^\\])cosx/g, '$1\\cos x ')).replace(
                    /\u2013/g,
                    '-'
                )),
                e
                ...
                if (a) {
                    ...
                    if (i)
                        return (
                            (i = i.replace('_{#?}', '')),
                            (i = i.replace('^{#?}', '')),
                            { match: i, rest: t.substring(i.length) }
                        );
                }
                if (((a = t.match(/^([a-zA-Z])/)), a))
                    return { match: a[1], rest: t.substring(1) };
                if (((a = t.match(/^(-)?\d+(\.\d*)?/)), a))
                    return { match: a[0], rest: t.substring(a[0].length) };
                /^\\(left|right)/.test(t) ||
                    ((a = t.match(/^(\\[a-zA-Z]+)/)),
                    a && ((s = t.substring(a[1].length)), (i = a[1])));
            }
        ...
        (we.prototype._announce = function(t, e, i) {
            ...
            (we.prototype.filter = function(t, e) {
                ...
                (s.path = me.clone(this.path)),
                    ...
                    e >= 0
                        ? s.collapseForward()
                        : (s.collapseBackward(), s.move(1));
                const a = s.anchor();
                do {
                    t.bind(s)(s.path, s.anchor()) && i.push(s.toString()),
                        e >= 0
                            ? s.next({ iterateAll: !0 })
                            : s.previous({ iterateAll: !0 });
                } while (a !== s.anchor());
                return i;
            }),
            ...
            (we.prototype.forEachSelected = function(t, e) {
                ...
                if (e.recursive)
                    for (let e = s; e < a; e++)
                        i[e] && 'first' !== i[e].type && i[e].forEach(t);
                else
                    for (let e = s; e < a; e++)
                ...
                if (t && t.length <= 1) {
                    ...
                    if (
                        ('numer' === i
                            ...
                            : 'denom' === i
                            ? (e = 'denominator')
                            : 'surd' === this.parent().type && 'body' === i
                            ? (e = 'radicand')
                            : 'overunder' === this.parent().type && 'body' === i
                            ? (e = 'base')
                            : ('underscript' !== i && 'overscript' !== i) ||
                              (e = 'annotation'),
                        e)
                    ) {
                        const e = [
            ...
            (we.prototype.wordBoundary = function(t, e) {
                ...
                return (
                    i.sibling(s) || (s -= e),
                    (i.path[i.path.length - 1].offset += s),
                    i.path
                );
            }),
            (we.prototype.wordBoundaryOffset = function(t, e) {
                ...
                if (At.LETTER_AND_DIGITS.test(i[t].body)) {
                    ...
                    s = i[o] ? o - 2 * e : o - e;
                } else if (/\s/.test(i[t].body)) {
                    let a = t;
                    for (
                        ;
                        i[a] && 'text' === i[a].mode && /\s/.test(i[a].body);
                    ...
                    if (i[a]) {
                        let t = !0;
                        do {
                            (t = 'text' === i[a].mode && !/\s/.test(i[a].body)),
                                (a += e);
                        } while (i[a] && t);
                        s = i[a] ? a - 2 * e : a - e;
                    } else s = a - e;
                    ...
                    let o = !0;
                    for (; i[a] && o; )
                        (o = 'text' === i[a].mode && /\s/.test(i[a].body)),
                            o && (s = a),
                            (a += e);
                    s = i[a] ? a - 2 * e : a - e;
                }
            ...
            (we.prototype.setRange = function(t, e, i) {
                ...
                return (
                    n <= 0
                        ? e.length > o + 1
                            ? ((a[o].relation = e[o].relation),
                              (a[o].offset = e[o].offset),
                        ...
                        : e.length <= t.length
                        ? (a[a.length - 1].offset -= 1)
                        : e.length > t.length && (a[o].offset -= 1),
                    this.setPath(a, n)
                );
            }),
            ...
            (we.prototype.extractCommandStringAroundInsertionPoint = function(
                ...
                let e = '';
                const i = this.commandOffsets();
                if (i) {
                    const s = t ? this.anchorOffset() + 1 : i.end,
                        a = this.siblings();
                    for (let t = i.start; t < s; t++) e += a[t].body || '';
                }
                return e;
            }),
            ...
            (we.prototype.commitCommandStringBeforeInsertionPoint = function() {
                ...
                if (t) {
                    const e = this.siblings(),
                        i = this.anchorOffset() + 1;
                    for (let s = t.start; s < i; s++)
            ...
            (we.prototype.spliceCommandStringAroundInsertionPoint = function(
                ...
                if (e) {
                    if ((this.contentWillChange(), t)) {
                        ...
                        for (const e of t)
                            i = i.concat(
                                e.filter(t => 'placeholder' === t.type)
                            );
                        this.setExtent(0),
                            (this.path[this.path.length - 1].offset =
                                e.start - 1),
                            (0 !== i.length && this.leap(1, !1)) ||
            ...
            (we.prototype.extractArgBeforeInsertionPoint = function() {
                ...
                if ('text' === t[i].mode)
                    for (; i >= 1 && 'text' === t[i].mode; )
                        e.unshift(t[i]), i--;
                else
                    for (
                        ;
                        i >= 1 &&
                        /^(mord|surd|msubsup|leftright|mop)$/.test(t[i].type);
            ...
            (we.prototype.setSelection = function(t, e, i) {
                ...
                i || (i = s);
                const a = this.parent();
                if (!a && 'body' !== i) return !1;
                const o = i.startsWith('cell');
                if ((!o && !a[i]) || (o && !a.array)) return !1;
                const n = i !== s;
                this.path[this.path.length - 1].relation = i;
                const r = this.siblings().length;
                this.path[this.path.length - 1].relation = s;
                const l = this.extent;
                'end' === e ? (e = r - t - 1) : 'start' === e && (e = -t),
                    this.setExtent(e);
            ...
            (we.prototype.next = function(t) {
                ...
                if (this.anchorOffset() === this.siblings().length - 1) {
                    ...
                    if (this.parent().array) {
                        ...
                        let e =
                            parseInt(
                                this.relation().match(/cell([0-9]*)$/)[1]
                            ) + 1;
                        for (; e < t; ) {
                            if (
            ...
            (we.prototype.previous = function(t) {
                ...
                if (
                    ...
                    const i = this.parent() ? this.parent().type : 'none';
                    if (
                        ('body' !== t ||
                            ('msubsup' !== i && 'mop' !== i) ||
                            (t = null),
                ...
                if (a < 0 && 0 !== i) {
                    if (this.path.length > 1)
                        return (
                            ...
                            this.setExtent(-1),
                            this.selectionDidChange(),
                            void this._announce('move', s)
                        );
                    (e = this.path[this.path.length - 1].offset),
                        (i = this.extent);
            ...
            (we.prototype.skip = function(t, e) {
                ...
                let n = o + t;
                if (
                    (i && (n = Math.min(Math.max(0, n), a.length - 1)),
                    n < 0 || n >= a.length)
                )
                    this.move(t, e);
                else {
                    if (a[n] && 'text' === a[n].mode) {
                        if (((n = this.wordBoundaryOffset(n, t)), n < 0 && !i))
                            return void this.setSelection(0);
                        if (n > a.length)
                            return (
                                this.setSelection(a.length - 1),
                                void this.move(t, e)
                            );
                    } else {
            ...
            (we.prototype.jumpToMathFieldBoundary = function(t, e) {
                ...
                i
                    ? t < 0
                        ? a[0].offset > 0 && (o = -a[0].offset)
                        : a[0].offset < this.siblings().length - 1 &&
                          (o = this.siblings().length - 1 - a[0].offset)
                    : ((a[0].offset = t < 0 ? 0 : this.root.body.length - 1),
                      (o = 0)),
                    this.setPath(a, o),
                    this._announce('move', s);
            }),
                ...
                if (0 === o.length) {
                    if ((this.setPath(s, a), e))
                        if (this.config.onTabOutOf)
                            ...
                            let s = i.indexOf(document.activeElement) + t;
                            s < 0 && (s = i.length - 1),
                                s >= i.length && (s = 0),
                                i[s].focus();
                        }
                    return (this.suppressChangeNotifications = i), !1;
                }
                return (
                    this.selectionWillChange(),
                    this.setPath(o[0]),
                    ...
                    for (let e = 0; t[e]; e++)
                        if (
                            ...
                            let i = 0,
                                s = 0,
                                a = 0;
                            for (let o = 0; t[e].body[o]; o++)
                                'genfrac' === t[e].body[o].type &&
                                    (i++, (s = o)),
                                    'first' !== t[e].body[o].type && a++;
                            0 === a && 1 === i && (t[e] = t[e].body[s]);
                        }
                    t.forEach(t => {
                        if (
                            ('genfrac' === t.type &&
            ...
            (we.prototype.insert = function(t, e) {
                ...
                let o;
                const r = [this.getSelectedAtoms()];
                void 0 !== e.placeholder && (r['?'] = e.placeholder),
                        ...
                        '' === t
                            ...
                            : ((t = Ee(t, this.config)),
                              r[0]
                                  ...
                                  : /(^|[^\\])#@/.test(t)
                                  ? ((t = t.replace(/(^|[^\\])#@/g, '$1#0')),
                                    (r[0] = this.extractArgBeforeInsertionPoint()),
                                    this._deleteAtoms(-r[0].length),
                                    Array.isArray(r[0]) &&
                                        0 === r[0].length &&
                                        (r[0] = void 0))
                                  : (t = t.replace(/(^|[^\\])#@/g, '$1#?')),
                ...
                if (
                    ...
                    'genfrac' === o[0].type
                        ? (this.path.pop(),
                          (this.siblings()[this.anchorOffset()] = o[0]))
                        : Array.prototype.splice.apply(
                              this.siblings(),
                              [this.anchorOffset() + 1, 0].concat(o)
                          ),
                    this.insertFirstAtom(),
            ...
            (we.prototype._insertSmartFence = function(t, e) {
                ...
                if (s && ('leftright' !== i.type || '|' !== i.leftDelim)) {
                    ...
                    return (
                        ...
                        a && ((this.sibling(0).body = o), this.move(-1)),
                        !0
                    );
                }
                let a;
                if (
                    ...
                    for (
                        a = this.endOffset();
                        a >= 0 &&
                        ('leftright' !== s[a].type || '?' !== s[a].rightDelim);
                        a--
                    );
                    if (a >= 0)
                        return (
                            this.contentWillChange(),
                            (s[a].rightDelim = t),
                            (s[a].body = s[a].body.concat(
                                s.slice(a + 1, this.endOffset() + 1)
                            )),
                            s.splice(a + 1, this.endOffset() - a),
                            this.setSelection(a),
                            this.contentDidChange(),
                            !0
                        );
                    if (i && 'leftright' === i.type && '?' === i.rightDelim) {
                        this.contentWillChange(), (i.rightDelim = t);
                        const e = s.slice(this.endOffset() + 1);
                        return (
                            s.splice(this.endOffset() + 1),
                            this.path.pop(),
                            Array.prototype.splice.apply(
                                this.siblings(),
                    ...
                    const o = this.ancestor(2);
                    return o &&
                        'leftright' === o.type &&
                        '?' === o.rightDelim &&
                        this.endOffset() === s.length - 1
            ...
            (we.prototype.delete_ = function(t) {
                ...
                if (this.isCollapsed()) {
                    ...
                    const t = this.startOffset() + 1,
                        e = this.endOffset() + 1;
                    this._announce('deleted', null, i.slice(t, e)),
                        i.splice(t, e - t),
            ...
            (we.prototype._applyStyle = function(t) {
                ...
                t.color && i('color', t.color) && (t.color = 'none'),
                    t.backgroundColor &&
                    ...
                    t.fontSeries &&
                        i('fontSeries', t.fontSeries) &&
                        (t.fontSeries = 'auto'),
                    t.shape && (t.fontShape = t.shape),
                    t.fontShape &&
                        i('fontShape', t.fontShape) &&
                        (t.fontShape = 'auto'),
        ...
        function Ne(t) {
            ...
            return (
                ...
                i && t.altKey && s.push('Alt'),
                i && t.shiftKey && s.push('Shift'),
        ...
        function We(t, e) {
            ...
            function l() {
                if (
                    ...
                    return;
                const i = t.value;
                (t.value = ''), i.length > 0 && e.typedText(i);
            }
            ...
            c.addEventListener(
                ...
                function(i) {
                    if (
                        ('function' == typeof e.allowDeadKey &&
                            e.allowDeadKey()) ||
                        ('Dead' !== i.key &&
                            'Unidentified' !== i.key &&
                            229 !== i.keyCode)
        ...
        const Ve = {
                ...
                '\\textsf': '\\textsf{ABC abc}',
                '\\textcolor':
                    '{\\textcolor{m0}A}{\\textcolor{m1}B}{\\textcolor{m2}C }{\\textcolor{m3}a}{\\textcolor{m4}b}{\\textcolor{m5}c}{\\textcolor{m6}8}',
                '\\color':
                    '{\\color{m0}A}{\\color{m1}B}{\\color{m2}C}{\\color{m3}a}{\\color{m4}b}{\\color{m5}c}{\\color{m6}8}',
        ...
        function Ze(t, e) {
            const i =
                ...
                n = t.virtualKeyboardVisible
                    ? t.virtualKeyboard.offsetHeight
                    : 0;
            e.x + t.popover.offsetWidth / 2 > s - a
                ? (t.popover.style.left = s - t.popover.offsetWidth - a + 'px')
                : e.x - t.popover.offsetWidth / 2 < 0
                ? (t.popover.style.left = 0)
                : (t.popover.style.left =
                      e.x - t.popover.offsetWidth / 2 + 'px'),
                e.y + t.popover.offsetHeight + 5 > i - o - n
        ...
        var Je = {
            ...
            showPopoverWithLatex: function(t, e, i) {
                ...
                (l += '<span class="ML__popover__content" role="button">'),
                    (l += '<div class="ML__popover__command">' + a + '</div>'),
                    o &&
                        (l += '<div class="ML__popover__note">' + o + '</div>'),
                    r &&
                        (l +=
                    ...
                    (l += i
                        ...
                        : ''),
                    Ge(t, l);
                let c = t.popover.getElementsByClassName(
                ...
                c &&
                    ...
                    (c = t.popover.getElementsByClassName(
                    ...
                    c &&
                        c.length > 0 &&
                        t._attachButtonHandlers(c[0], 'nextSuggestion');
            },
            showPopover: Ge,
            hidePopover: Xe,
            updatePopoverPosition: function t(e, i) {
                if (
                    e.element &&
                    ...
                    if (i && i.deferred)
                        window.requestAnimationFrame(() => t(e));
                    else if (
                        e.mathlist.anchor() &&
        ...
        function Ye(t, e, i) {
            ...
            if (Array.isArray(e) && e.length > 0) {
                if ('first' === e[0].type && 0 === (e = e.slice(1)).length)
                    return '';
                s = (function t(e, i, s, a) {
                    if (0 === s.length) return '';
                    if (0 === i.length)
                        return s.map(t => t.toLatex(a)).join('');
                    let o = '',
                        n = '',
                        r = '';
                    const l = i[0];
                    let c = s[0][l];
                    'fontFamily' === l &&
                        (c = s[0].fontFamily || s[0].baseFontFamily);
                    const h = (function(t, e, i) {
                        ...
                        if ('fontFamily' === e)
                            for (
                                ...
                                t[s] &&
                                ('mop' === t[s].type ||
                                    (t[s].fontFamily || t[s].baseFontFamily) ===
                                        i);
                    ...
                    if ('text' === s[0].mode) {
                        if ('fontShape' === l && s[0].fontShape)
                            'it' === s[0].fontShape
                                ...
                                : ((n =
                                      ...
                                      '}'),
                                  (r = '}'));
                        else if ('fontSeries' === l && s[0].fontSeries)
                            'b' === s[0].fontSeries
                                ? ((n = '\\textbf{'), (r = '}'))
                                : 'l' === s[0].fontSeries
                                ? ((n = '\\textlf{'), (r = '}'))
                            ...
                            t || ((n = '\\text{'), (r = '}'));
                        } else if ('fontSize' === l && s[0].fontSize)
                            (n =
                                '{\\' +
                                ({
                                    size1: 'tiny',
                            ...
                            'fontFamily' === l &&
                            (s[0].fontFamily || s[0].baseFontFamily)
                        ) {
                            const t =
                                {
                                    cmr: 'textrm',
                        ...
                        if ('fontSeries' === l)
                            ...
                            (n =
                                ...
                                ' '),
                                (r = '}');
                        else if ('fontFamily' === l && s[0].fontFamily) {
                            if (!/^(math|main)$/.test(s[0].fontFamily)) {
                                const o =
                                    {
                                        cal: 'mathcal',
                                        frak: 'mathfrak',
                                ...
                                if (o) {
                                    if (/^\\operatorname{/.test(s[0].latex))
                                        return (
                                            s[0].latex + t(e, i, s.slice(h), a)
                                        );
                                    s[0].isFunction ||
                                        ((n = '\\' + o + '{'), (r = '}')),
                                        (i = []);
                        ...
                        } else if ('fontFamily' === l && s[0].baseFontFamily)
                            if (s[0].latex && s[0].latex.startsWith('\\'))
                                (n = ''), (r = '');
                            else {
                                const t =
                                    {
                    ...
                    return (
                        'color' !== l ||
                            ...
                            'none' === s[0].color ||
                            (e && e.color === s[0].color) ||
                            ((n = '\\textcolor{' + ae(s[0].color) + '}{'),
                            (r = '}')),
                        'backgroundColor' !== l ||
                            !s[0].backgroundColor ||
                            'none' === s[0].backgroundColor ||
                            (e && e.backgroundColor === s[0].backgroundColor) ||
                            ((n =
                                '\\colorbox{' +
                                ae(s[0].backgroundColor) +
                                '}{'),
                            (r = '}')),
                        (o += n),
                        (o += t(e, i.slice(1), s.slice(0, h), a)),
                        (o += r),
                        (o += t(e, i, s.slice(h), a)),
                        o
                    );
                ...
                'number' == typeof e || 'boolean' == typeof e
                    ...
                    : 'string' == typeof e
                    ? (s = e.replace(/\s/g, '~'))
                    : e && 'function' == typeof e.toLatex && (s = e.toLatex(i));
            return s;
        }
        function Qe(t) {
            const e = Qe.locale.substring(0, 2);
            let i = '';
            return (
                Qe.strings[Qe.locale] && (i = Qe.strings[Qe.locale][t]),
                !i && Qe.strings[e] && (i = Qe.strings[e][t]),
                i || (i = Qe.strings.en[t]),
                i || (i = t),
                i
            );
        }
        (te.MathAtom.prototype.toLatex = function(t) {
            t = void 0 !== t && t;
            let e,
                i = '',
                s = 0,
                a = 0;
            const o = this.latex ? this.latex.match(/^(\\[^{\s0-9]+)/) : null,
                n = o ? o[1] : null;
            switch (this.type) {
                case 'group':
                    (i +=
                        this.latexOpen ||
                        (this.cssId || this.cssClass ? '' : '{')),
                        this.cssId && (i += '\\cssId{' + this.cssId + '}{'),
                        'ML__emph' === this.cssClass
                            ? (i += '\\emph{' + Ye(this, this.body, t) + '}')
                            : (this.cssClass &&
                                  (i += '\\class{' + this.cssClass + '}{'),
                              (i += t
                                  ? Ye(this, this.body, !0)
                                  : this.latex || Ye(this, this.body, !1)),
                              this.cssClass && (i += '}')),
                        this.cssId && (i += '}'),
                        (i +=
                            this.latexClose ||
                ...
                case 'array':
                    if (
                        ((i += '\\begin{' + this.env.name + '}'),
                        'array' === this.env.name)
                    ) {
                        if (((i += '{'), this.colFormat))
                            for (a = 0; a < this.colFormat.length; a++)
                                this.colFormat[a].align
                                    ? (i += this.colFormat[a].align)
                                    : this.colFormat[a].rule && (i += '|');
                        i += '}';
                    }
                    for (s = 0; s < this.array.length; s++) {
                        for (e = 0; e < this.array[s].length; e++)
                            e > 0 && (i += ' & '),
                                (i += Ye(this, this.array[s][e], t));
                        s < this.array.length - 1 && (i += ' \\\\ ');
                    }
                    i += '\\end{' + this.env.name + '}';
                    break;
                case 'root':
                    i = Ye(this, this.body, t);
                    break;
                case 'genfrac':
                    /^(choose|atop|over)$/.test(this.body)
                        ? ((i += '{'),
                          (i += Ye(this, this.numer, t)),
                          (i += '\\' + this.body + ' '),
                          (i += Ye(this, this.denom, t)),
                          (i += '}'))
                        : ((i += n),
                          (i += `{${Ye(this, this.numer, t)}}{${Ye(
                              this,
                              this.denom,
                              t
                          )}}`));
                ...
                case 'surd':
                    (i += '\\sqrt'),
                        this.index &&
                            ((i += '['),
                            (i += Ye(this, this.index, t)),
                            (i += ']')),
                        (i += `{${Ye(this, this.body, t)}}`);
                    break;
                case 'leftright':
                    this.inner
                        ? ((i += '\\left' + (this.leftDelim || '.')),
                          this.leftDelim &&
                              this.leftDelim.length > 1 &&
                              (i += ' '),
                          (i += Ye(this, this.body, t)),
                          (i += '\\right' + (this.rightDelim || '.')),
                          this.rightDelim &&
                              this.rightDelim.length > 1 &&
                              (i += ' '))
                        : t && '(' === this.leftDelim && ')' === this.rightDelim
                        ? (i += '(' + Ye(this, this.body, t) + ')')
                        : ((i += '\\mleft' + (this.leftDelim || '.')),
                          this.leftDelim &&
                              this.leftDelim.length > 1 &&
                              (i += ' '),
                          (i += Ye(this, this.body, t)),
                          (i += '\\mright' + (this.rightDelim || '.')),
                          this.rightDelim &&
                              this.rightDelim.length > 1 &&
                              (i += ' '));
                    break;
                ...
                case 'rule':
                    (i += n),
                        this.shift && (i += `[${Ye(this, this.shift, t)}em]`),
                        (i += `{${Ye(this, this.width, t)}em}{${Ye(
                            this,
                            this.height,
                            t
                        )}em}`);
                    ...
                    /^\\(mathbin|mathrel|mathopen|mathclose|mathpunct|mathord|mathinner)/.test(
                        ...
                        ? ((i += '\\unicode{"'),
                          (i += (
                              ...
                              .substr(-6)),
                          (i += '}'))
                        : (this.latex || 'string' == typeof this.body) &&
                          (this.latex && '\\' === this.latex[0]
                              ? ((i += this.latex),
                                /[a-zA-Z0-9]$/.test(this.latex) && (i += ' '))
                              : (i +=
                                    n ||
                                    ('​' !== this.body
                        ...
                        ('\\mathop' === n
                            ...
                            : (i +=
                                  ...
                                  ('​' !== this.body
                                      ...
                                      : ''))),
                        this.explicitLimits &&
                            ('limits' === this.limits && (i += '\\limits '),
                            'nolimits' === this.limits && (i += '\\nolimits '));
                    break;
                case 'box':
                    if ('\\bbox' === n) {
                        if (
                            ...
                            isFinite(this.padding) &&
                                t.push(
                                    Math.floor(100 * this.padding) / 100 + 'em'
                                ),
                                this.border && t.push('border:' + this.border),
                                this.backgroundcolor &&
                                    t.push(ae(this.backgroundcolor)),
                                (i += `[${t.join(',')}]`);
                        }
                        i += `{${Ye(this, this.body, t)}}`;
                    } else
                        '\\boxed' === n
                            ? (i += `\\boxed{${Ye(this, this.body, t)}}`)
                            : ((i += n),
                              this.framecolor &&
                                  (i += `{${ae(this.framecolor)}}`),
                              this.backgroundcolor &&
                                  (i += `{${ae(this.backgroundcolor)}}`),
                              (i += `{${Ye(this, this.body, t)}}`));
                    break;
                case 'spacing':
                    (i += n),
                        '\\hspace' === n || '\\hspace*' === n
                            ? ((i += '{'),
                              ...
                              (i += '}'))
                            : ((i += ' '),
                              this.width && (i += this.width + 'em '));
                    break;
                case 'enclose':
                    if (((i += n), '\\enclose' === n)) {
                        i += '{';
                        let t = '';
                        for (const e in this.notation)
                            Object.prototype.hasOwnProperty.call(
                                this.notation,
                                e
                            ) &&
                        ...
                        (t = ''),
                            this.backgroundcolor &&
                                ...
                                ((e +=
                                    t +
                                    'mathbackground="' +
                                    ae(this.backgroundcolor) +
                                    '"'),
                                (t = ',')),
                            this.shadow &&
                                'auto' !== this.shadow &&
                                ((e += t + 'shadow="' + this.shadow + '"'),
                                (t = ',')),
                            1 !== this.strokeWidth ||
                            'solid' !== this.strokeStyle
            ...
            if (this.superscript) {
                let e = Ye(this, this.superscript, t);
                1 === e.length
                    ? ('′' === e
                          ? (e = '\\prime ')
                          : '″' === e && (e = '\\doubleprime '),
            ...
            if (this.subscript) {
                const e = Ye(this, this.subscript, t);
                1 === e.length ? (i += '_' + e) : (i += '_{' + e + '}');
            }
            return i;
        }),
            (Qe.plural = function(t, e, i) {
                (i = i || {}).type = i.type || 'cardinal';
                const s = Qe.locale.substring(0, 2),
                    a = 'ordinal' === i.type ? Qe.ordinal : Qe.cardinal;
                let o,
                    n =
                        'ordinal' === i.type
                            ? Qe._ordinalPluralCategories.indexOf(a.select(t))
                            : Qe._cardinalPluralCategories.indexOf(a.select(t));
                return (
                    Qe.strings[Qe.locale] && (o = Qe.strings[Qe.locale][e]),
                    !o && Qe.strings[s] && (o = Qe.strings[s][e]),
                    o ||
                        ((o = Qe.strings.en[e]),
                        o || (o = e),
                        (n =
                            'ordinal' === i.type
                                ? Qe._ordinalPluralCategories.indexOf(
                                      Qe._ordinalEnglish.select(t)
                                  )
                                : Qe._cardinalPluralCategories.indexOf(
                                      Qe._cardinalEnglish.select(t)
                                  ))),
                    o.split(';')[n] || o.split(';')[0]
                );
            }),
            (Qe.merge = function(t, e) {
                if (t && e) {
                    const i = Qe._locale;
                    (Qe.locale = t),
                        (Qe.strings[t] = { ...Qe.strings[t], ...e }),
                        (Qe.locale = i);
                } else
                    t &&
                        !e &&
                        ((e = t),
                        Object.keys(e).forEach(t => Qe.merge(t, e[t])));
            }),
            Object.defineProperty(Qe, 'locale', {
                set(t) {
                    (Qe._locale = t),
                        (Qe._ordinal = null),
                        (Qe._cardinal = null);
            ...
            Object.defineProperty(Qe, 'ordinal', {
                get: () => (
                    Qe._ordinal ||
                        ((Qe._ordinalEnglish = new Intl.PluralRules('en', {
                            type: 'ordinal',
                        })),
                        (Qe._ordinalEnglishPluralCategories = Qe._ordinalEnglish.resolvedOptions().pluralCategories),
                        (Qe._ordinal = new Intl.PluralRules(Qe.locale, {
                            type: 'ordinal',
                        })),
                        (Qe._ordinalPluralCategories = Qe._ordinal.resolvedOptions().pluralCategories)),
                    Qe._ordinal
                ),
            }),
            Object.defineProperty(Qe, 'cardinal', {
                get: () => (
                    Qe._cardinal ||
                        ((Qe._cardinalEnglish = new Intl.PluralRules('en', {
                            type: 'cardinal',
                        })),
                        (Qe._cardinalEnglishPluralCategories = Qe._cardinalEnglish.resolvedOptions().pluralCategories),
                        (Qe._cardinal = new Intl.PluralRules(Qe.locale, {
                            type: 'cardinal',
                        })),
                        (Qe._cardinaPluralCategories = Qe._ordinal.resolvedOptions().pluralCategories)),
                    Qe._cardinal
                ),
            }),
            (Qe.strings = {
        ...
        function oi(t, e, i) {
            t = t.replace(/(^|[^\\])#@/g, '$1#?');
            const s = he.parseTokens(n(t), 'math', e, i.config.macros),
                a = te.decompose(
        ...
        function ni(t, e, i) {
            let s = "<div class='left'>";
            const a = e.replace(/\s+/g, ' ').split(' ');
            if (a.length > 1) {
                const e = Object.assign(
                    {},
                    ti,
                    t.config.customVirtualKeyboards || {}
                );
                for (const t of a) {
                    if (!e[t]) break;
                    (s += "<div class='"),
                        ...
                        (s += (e[t].classes || '') + "'"),
                        e[t].tooltip &&
                            ((s += "data-tooltip='" + Qe(e[t].tooltip) + "' "),
                            (s += "data-placement='top' data-delay='1s'")),
                        t !== i &&
                            (e[t].command &&
                                (s +=
                                    'data-command=\'"' + e[t].command + '"\''),
                            e[t].layer &&
            ...
            return (
                ...
                "<div class='keyboard-toolbar' role='toolbar'>" + s + '</div>'
            );
        }
        function ri(t, e, i) {
            for (let s = 0; s < e.length; ++s) {
                ...
                if (
                    ...
                    n &&
                        ei[n] &&
                        (a.setAttribute('data-shifted', ei[n].label),
                        a.setAttribute(
                    ...
                    const t = si[a.getAttribute('data-alt-keys')];
                    t &&
                        (o = {
                            default: o,
                            pressAndHoldStart: [
        ...
        function li(t, e) {
            const i = {
                ...
                s = i[t.config.virtualKeyboardLayout]
                    ? i[t.config.virtualKeyboardLayout]
                    : i.qwerty;
            let a,
                o = e;
            o = o.replace(
            ...
            let n = o.match(/(<row\s+)(.*)((?:<\/row|\/)>)/);
            for (; n; ) {
                a = '';
                const t = n[2].match(/[a-zA-Z][a-zA-Z0-9-]*=(['"])(.*?)\1/g),
                    e = {};
                for (const i of t) {
                    const t = i.match(/([a-zA-Z][a-zA-Z0-9-]*)=(['"])(.*?)\2/);
                    e[t[1]] = t[3];
                }
                let r = s[e.name];
                if ((r || (r = i.qwerty[e.name]), r))
                    for (const t of r) {
                        let i = e.class || '';
                        i && (i = ' ' + i),
                            '~' === t
                ...
                (o = o.replace(new RegExp(n[1] + n[2] + n[3]), a)),
                    (n = o.match(/(<row\s+)(.*)((?:<\/row|\/)>)/));
            }
            return o;
        }
        var ci = {
            make: function(t, e) {
                ...
                const o = Object.assign(
                    ...
                    r = a.replace(/\s+/g, ' ').split(' ');
                for (const e of r) {
                    if (!n[e]) break;
                    let s = n[e].layers || [];
                    n[e].layer && s.push(n[e].layer),
                    ...
                    for (const n of s) {
                        ...
                        if ('object' == typeof o[n]) {
                            ...
                            if (
                                (o[n].styles &&
                                    (t += `<style>${o[n].styles}</style>`),
                                o[n].backdrop &&
                                    (t += `<div class='${o[n].backdrop}'>`),
                                o[n].container &&
                                    (t += `<div class='${o[n].container}'>`),
                                o[n].rows)
                            ) {
                                t += "<div class='rows'>";
                                for (const e of o[n].rows) {
                                    t += '<ul>';
                                    for (const i of e)
                                        (t += '<li'),
                                            i.class &&
                                            ...
                                            i.key &&
                                                (t += ` data-key="${i.key}"`),
                                            i.command &&
                                                ('string' == typeof i.command
                                                    ? (t += ` data-command='"${i.command}"'`)
                                                    : ((t += " data-command='"),
                                                      (t += JSON.stringify(
                                                          i.command
                                                      )),
                                                      (t += "'"))),
                                            i.insert &&
                                                (t += ` data-insert="${i.insert}"`),
                                            i.latex &&
                                                (t += ` data-latex="${i.latex}"`),
                                            i.aside &&
                                                (t += ` data-aside="${i.aside}"`),
                                            i.altKeys &&
                                                (t += ` data-alt-keys="${i.altKeys}"`),
                                            i.shifted &&
                                                (t += ` data-shifted="${i.shifted}"`),
                                            i.shiftedCommand &&
                                                (t += ` data-shifted-command="${i.shiftedCommand}"`),
                                            (t += `>${
                                                i.label ? i.label : ''
                                            }</li>`);
                                    t += '</ul>';
                        ...
                        (i +=
                            ...
                            "'>"),
                            (i += ni(t, a, e));
                        const s = 'function' == typeof o[n] ? o[n]() : o[n];
                        (i += li(t, s)), (i += '</div>');
                    }
                }
        ...
        function fi(t, e, i) {
            ...
            if (
                (t.index < e &&
                    ...
                    l.subscript && (r = t.index),
                    (t.index += 1)),
                o.length > 0)
            ) {
                if (
                    ((s = !0),
                    gi(t) && ((n = t.index), (t.index += 1)),
                    yi(t) && ((r = t.index), (t.index += 1)),
                    n >= 0 && r >= 0)
                )
                    (a = '<msubsup>' + o),
                        (a += Si(t.atoms[r].subscript, 0, 0, i).mathML),
                        (a += Si(t.atoms[n].superscript, 0, 0, i).mathML),
                        (a += '</msubsup>');
                else if (n >= 0) {
                    if (((a = '<msup>' + o), gi(t))) {
                        const e = Si(t.atoms[n].superscript, 0, 0, i).mathML,
                            s = Si(t.atoms[n + 1].superscript, 0, 0, i).mathML;
                        a +=
                            ('<mi>′</mi>' !== e && '<mi>&#x2032;</mi>' !== e) ||
                            ('<mi>′</mi>' !== s && '<mi>&#x2032;</mi>' !== s)
                                ? '<mi>′</mi>' === e ||
                                  '<mi>&#x2032;</mi>' === e
                                    ...
                                    : e
                                : '<mi>&#x2033;</mi>';
                    } else a += Si(t.atoms[n].superscript, 0, 0, i).mathML;
                    a += '</msup>';
                } else
                    r >= 0
                        ? ((a = '<msub>' + o),
                ...
                ('mi' !== t.lastType &&
                    ...
                    'fence' !== t.lastType) ||
                    /^<mo>(.*)<\/mo>$/.test(a) ||
                    (a = '<mo>&InvisibleTimes;</mo>' + a),
                    o.endsWith('>f</mi>') || o.endsWith('>g</mi>')
                        ? ((a += '<mo> &ApplyFunction; </mo>'),
                          (t.lastType = 'applyfunction'))
                        : (t.lastType = /^<mo>(.*)<\/mo>$/.test(a)
                              ? 'mo'
                              : 'mi'),
                    (t.mathML += a);
            }
        ...
        function bi(t, e, i) {
            ...
            return (
                ...
                (o.superscript ||
                    o.subscript ||
                    ((gi(e) || yi(e)) &&
                        ((o = e.atoms[e.index]), (e.index += 1))),
                !!o &&
                    (o.superscript && o.subscript
                        ? ((a = '<msubsup>' + t),
                          (a += Si(o.subscript, 0, 0, i).mathML),
                          (a += Si(o.superscript, 0, 0, i).mathML),
                          (a += '</msubsup>'))
                        : o.superscript
                        ? ((a = '<msup>' + t),
                          (a += Si(o.superscript, 0, 0, i).mathML),
        ...
        function xi(t, e, i) {
            ...
            for (; t.index < e && 'text' === t.atoms[t.index].mode; )
                (o += t.atoms[t.index].body ? t.atoms[t.index].body : ' '),
                    (t.index += 1);
            return (
                o.length > 0 &&
                    ((s = !0),
                    (o =
                        '<mtext' + ui(t.atoms[a].id, i) + '>' + o + '</mtext>'),
                    (t.mathML += o),
                    (t.lastType = 'mtext')),
                s
            );
            ...
            let o = '',
                n = (function(t) {
                    let e = -1,
                        ...
                        s = !1,
                        a = !1;
                    for (; i < t.atoms.length && !s && !a; )
                        (s =
                            'mord' !== t.atoms[i].type ||
                            '0123456789,.'.indexOf(t.atoms[i].body) < 0),
                            (a = !s && t.atoms[i].superscript),
                            i++;
                    return a && (e = i - 1), e;
                })(t);
            for (
                ...
                (o += t.atoms[t.index].body), (t.index += 1);
            return (
                o.length > 0 &&
                    ((s = !0),
                    (o = '<mn' + ui(t.atoms[a].id, i) + '>' + o + '</mn>'),
                    n < 0 && gi(t) && ((n = t.index), (t.index += 1)),
                    n >= 0 &&
                        ((o = '<msup>' + o),
                        (o += Si(t.atoms[n].superscript, 0, 0, i).mathML),
                        (o += '</msup>')),
                    (t.mathML += o),
                    (t.lastType = 'mn')),
                s
            ...
            if (t.index < e && 'mopen' === t.atoms[t.index].type) {
                ...
                for (; h < e && !n; )
                    'mopen' === t.atoms[h].type
                        ? (r += 1)
                        : 'mclose' === t.atoms[h].type && (r -= 1),
                        -1 === r && ((n = !0), (c = h)),
                        (h += 1);
                n &&
                    ((a = '<mrow>'),
                    (a += Ai(t.atoms[l], i)),
                    (a += Si(t.atoms, l + 1, c, i).mathML),
                    (a += Ai(t.atoms[c], i)),
                    (a += '</mrow>'),
                    ('mi' !== t.lastType &&
                        'mn' !== t.lastType &&
                        ...
                        (a = '<mo>&InvisibleTimes;</mo>' + a),
                    (t.index = c + 1),
                    bi(a, t, i) && ((s = !0), (t.lastType = ''), (a = '')),
                    (o = 'fence'));
            }
            return (
                a.length > 0 && ((s = !0), (t.mathML += a), (t.lastType = o)), s
            );
        }
        function wi(t, e, i) {
            let s = !1;
            ...
            if (t.index < e && ('mbin' === n.type || 'mrel' === n.type))
                (a += t.atoms[t.index].toMathML(i)), (t.index += 1), (o = 'mo');
                ...
                if ('limits' === n.limits && (n.superscript || n.subscript)) {
                    ...
                    n.superscript && n.subscript
                        ? ((a +=
                              ('nolimits' !== n.limits
                                  ? '<munderover>'
                                  : '<msubsup>') + t),
                          (a += Si(n.subscript, 0, 0, i).mathML),
                          (a += Si(n.superscript, 0, 0, i).mathML),
                          (a +=
                              'nolimits' !== n.limits
                                  ? '</munderover>'
                                  : '</msubsup>'))
                    ...
                    const e = t.atoms[t.index],
                        n = 0 === e.latex.indexOf('\\operatorname'),
                        r = n
        ...
        function Si(t, e, i, s) {
            const a = { atoms: t, index: e || 0, mathML: '', lastType: '' };
            if (
                ((i = i || (t ? t.length : 0)),
            ...
            else if (t && 'function' == typeof t.toMathML)
                a.mathML = t.toMathML(s);
            else if (Array.isArray(t)) {
                let t = 0;
                for (; a.index < i; )
                    if (
                        ...
                        let e = a.atoms[a.index].toMathML(s);
                        'mn' === a.lastType &&
                            e.length > 0 &&
        ...
        function Ai(t, e) {
            let i = '';
            const s = Mi(t.body);
            return s && (i = '<mo' + ui(t.id, e) + '>' + s + '</mo>'), i;
        }
        function Mi(t) {
            if (!t) return '';
            if ('string' == typeof t) return mi(t);
            if (!Array.isArray(t) && 'string' == typeof t.body)
                return mi(t.body);
            let e = '';
            for (const i of t) 'string' == typeof i.body && (e += i.body);
            return mi(e);
        }
        (te.MathAtom.prototype.toMathML = function(t) {
            const e = {
                    '\\exponentialE': '&#x02147;',
                    '\\imaginaryI': '&#x2148;',
                    '\\differentialD': '&#x2146;',
            ...
            d && (d = ' mathvariant="' + d + '"');
            const p = this.latex ? this.latex.trim() : null;
            if ('text' === this.mode)
                c = '<mi' + ui(this.id, t) + '>' + this.body + '</mi>';
            else
                switch (this.type) {
                    case 'first':
                        break;
                    ...
                    case 'array':
                        if (
                            ...
                            for (
                                c += ' columnalign="', o = 0;
                                o < this.colFormat.length;
                                o++
                            )
                                this.colFormat[o].align &&
                                    (c +=
                        ...
                        for (c += '>', a = 0; a < this.array.length; a++) {
                            for (
                                c += '<mtr>', s = 0;
                                s < this.array[a].length;
                                s++
                            )
                                c +=
                                    '<mtd>' +
                                    Si(this.array[a][s], 0, 0, t).mathML +
                                    '</mtd>';
                            c += '</mtr>';
                        }
                        (c += '</mtable>'),
                            ((this.lFence && '.' !== this.lFence) ||
                                ...
                                (this.rFence &&
                                    ...
                                    (c +=
                                        '<mo>' +
                                        (pi[this.lFence] || this.rFence) +
                                        '</mo>'),
                                (c += '</mrow>'));
                        break;
                    case 'genfrac':
                        (this.leftDelim || this.rightDelim) && (c += '<mrow>'),
                            this.leftDelim &&
                                '.' !== this.leftDelim &&
                                (c +=
                                    '<mo' +
                                    ui(this.id, t) +
                                    '>' +
                                    (pi[this.leftDelim] || this.leftDelim) +
                                    '</mo>'),
                            this.hasBarLine
                                ? ((c += '<mfrac>'),
                                  (c +=
                                      Si(this.numer, 0, 0, t).mathML ||
                                      '<mi>&nbsp;</mi>'),
                                  (c +=
                                      Si(this.denom, 0, 0, t).mathML ||
                                      '<mi>&nbsp;</mi>'),
                                  (c += '</mfrac>'))
                                : ((c += '<mtable' + ui(this.id, t) + '>'),
                                  (c +=
                                      '<mtr>' +
                                      Si(this.numer, 0, 0, t).mathML +
                                      '</mtr>'),
                            ...
                            this.rightDelim &&
                                ...
                                (c +=
                                    ...
                                    ui(this.id, t) +
                                    '>' +
                                    (pi[this.rightDelim] || this.rightDelim) +
                                    '</mo>'),
                    ...
                    case 'surd':
                        this.index
                            ? ((c += '<mroot' + ui(this.id, t) + '>'),
                              (c += Si(this.body, 0, 0, t).mathML),
                              (c += Si(this.index, 0, 0, t).mathML),
                              (c += '</mroot>'))
                            : ((c += '<msqrt' + ui(this.id, t) + '>'),
                              (c += Si(this.body, 0, 0, t).mathML),
                              (c += '</msqrt>'));
                        break;
                    case 'leftright':
                        (c = '<mrow>'),
                            this.leftDelim &&
                                ...
                                (c +=
                                    ...
                                    (pi[this.leftDelim] || this.leftDelim) +
                                    '</mo>'),
                            this.body && (c += Si(this.body, 0, 0, t).mathML),
                            this.rightDelim &&
                                '.' !== this.rightDelim &&
                                (c +=
                                    '<mo' +
                    ...
                    case 'delim':
                        c +=
                            ...
                            ui(this.id, t) +
                            '>' +
                            (pi[this.delim] || this.delim) +
                            '</mo>';
                        break;
                    case 'accent':
                        (c += '<mover accent="true"' + ui(this.id, t) + '>'),
                            (c += Si(this.body, 0, 0, t).mathML),
                            (c += '<mo>' + (pi[p] || this.accent) + '</mo>'),
                            (c += '</mover>');
                        break;
                    case 'line':
                    case 'overlap':
                    ...
                    case 'overunder':
                        (r = this.overscript),
                            ...
                            r && n
                                ...
                                : r
                                ? ((l = this.body),
                                  this.body[0] && this.body[0].underscript
                                      ? ((n = this.body[0].underscript),
                                        (l = this.body[0].body))
                                      : this.body[0] &&
                                        'first' === this.body[0].type &&
                                        this.body[1] &&
                                        this.body[1].underscript &&
                                        ((n = this.body[1].underscript),
                                        (l = this.body[1].body)))
                                : n &&
                                  ((l = this.body),
                                  this.body[0] && this.body[0].overscript
                                      ? ((r = this.body[0].overscript),
                                        (l = this.body[0].body))
                                      : this.body[0] &&
                                        'first' === this.body[0].type &&
                                        this.body[1] &&
                                        this.body[1].overscript &&
                                        ((r = this.body[1].overscript),
                                        (l = this.body[1].body))),
                            r && n
                                ? ((c +=
                                      '<munderover' +
                              ...
                              (c =
                                  ...
                                  this.body.charCodeAt(0) > 255
                                      ? '&#x' +
                                        (
                                            '000000' +
                                            this.body.charCodeAt(0).toString(16)
                                        ).substr(-4) +
                                        ';'
                                      : 'string' == typeof this.body
                                      ? this.body.charAt(0)
                                      : this.body);
                        const s = /\d/.test(c) ? 'mn' : 'mi';
                        c =
                            '<' +
                            s +
                            d +
                    ...
                    case 'minner':
                        c =
                            p && e[p]
                                ? '<mi' + ui(this.id, t) + '>' + e[p] + '</mi>'
                                : p && pi[p]
                                ? '<mo' + ui(this.id, t) + '>' + pi[p] + '</mo>'
                                : Ai(this, t);
                        break;
                    case 'mpunct':
                        c =
                    ...
                    case 'mathstyle':
                        break;
                    case 'box':
                        (c = '<menclose notation="box"'),
                            this.backgroundcolor &&
                                (c +=
                                    ' mathbackground="' +
                                    se(this.backgroundcolor) +
                                    '"'),
                            (c +=
                                ui(this.id, t) +
                                '>' +
                                Si(this.body, 0, 0, t).mathML +
                                '</menclose>');
                        break;
                    case 'spacing':
                        c += '<mspace width="' + (i[p] || 0) + 'em"/>';
                        break;
                    case 'enclose':
                        c = '<menclose notation="';
            ...
            (te.toMathML = function(t, e) {
                return Si(t, 0, 0, e).mathML;
            });
        const Ci = {
                '\\imaginaryI': 'ⅈ',
                '\\imaginaryJ': 'ⅉ',
        ...
        function qi(t) {
            ...
            if (!e)
                if (/^\\[^{}]+$/.test(t)) {
                    const i = At.getInfo(t, 'math', {});
                    e = (i && i.value) || t.slice(1);
                } else e = t;
            return e;
        }
        function Ii(t) {
        ...
        function Ki(t) {
            ...
            if (
                t.latex &&
                !/^\\math(op|bin|rel|open|punct|ord|inner)/.test(t.latex)
            )
                return t.latex.trim();
        ...
        function Ni(t) {
            return 'string' == typeof t.sym
                ? (function(t) {
                      ...
                      return e || (e = At.unicodeStringToLatex('math', t)), e;
                  })(t.sym) || t.sym
                : '';
        }
        function Wi(t) {
        ...
        function Ui(t) {
            ...
            return (
                Hi(t) &&
                    'object' == typeof t.num &&
                    (e = void 0 !== t.num.im ? hs(t.num.im) : 0),
                e
            );
        }
        function ji(t) {
        ...
        function ts(t, e) {
            let i = t.atoms[t.index];
            return (
                !i || (void 0 === i.superscript && void 0 === i.subscript)
                    ? (i = null)
                    : (t.index += 1),
                i ||
                    ((i = t.atoms[t.index + 1]),
                    i && 'msubsup' === i.type && (i.superscript || i.subscript)
                        ? (t.index += 2)
                        : (i = null)),
                i
                    ? (void 0 !== i.subscript &&
        ...
        function es(t, e) {
            ...
            if (ss(t, '!!'))
                return (
                    (t.index += 1),
                    (t.ast = Xi('factorial2', i)),
                    es((t = ts(t, e)), e)
                );
            if (ss(t, '++'))
                return (
                    (t.index += 1),
                    (t.ast = Xi('increment', i)),
                    es((t = ts(t, e)), e)
                );
            if (ss(t, '--'))
                return (
                    (t.index += 1),
                    (t.ast = Xi('decrement', i)),
                    es((t = ts(t, e)), e)
                );
            const s = t.atoms[t.index];
            return (
                s &&
                    s.latex &&
                    Bi[s.latex.trim()] &&
        ...
        function is(t, e, i, s) {
            ...
            if (e) {
                if ('mopen' === o.type && Ki(o) === e)
                    ...
                    if (
                        ((o = t.atoms[t.index + 1]),
                        o && 'textord' === o.type && '|' === o.latex)
                    ) {
                        (t.index += 2), (o = (t = os(t, s)).atoms[t.index]);
                        const e = t.atoms[t.index + 1];
                        o &&
                            'textord' === o.type &&
                            '|' === o.latex &&
                            ...
                            'textord' === e.type &&
                            '|' === e.latex &&
                            ((t.index += 2), (t = es((t = ts(t, s)), s)));
                    }
                } else if ('sizeddelim' === o.type && o.delim === e)
                    (t.index += 1),
                        (o = (t = os(t, s)).atoms[t.index]),
                        o &&
                            'sizeddelim' === o.type &&
            ...
            }
            {
                ...
                if (
                    ('mopen' === o.type
                        ? ((e = o.latex.trim()), (i = At.RIGHT_DELIM[e]))
                        : 'sizeddelim' === o.type
                        ? ((e = o.delim), (i = At.RIGHT_DELIM[e]))
                        : 'leftright' === o.type
                        ? ((s = !1),
                          (e = o.leftDelim),
                          '?' === (i = o.rightDelim) && (i = At.RIGHT_DELIM[e]))
                        : 'textord' === o.type &&
                          ((e = o.latex.trim()), (i = At.RIGHT_DELIM[e])),
                    e && i)
                ) {
                    if ('|' === e && '|' === i) {
                        const s = t.atoms[t.index + 1];
                        s &&
                            'textord' === s.type &&
                            '|' === s.latex &&
                            ((e = '\\lVert'), (i = '\\rVert'));
        ...
        function as(t) {
            if (
                ...
                if (!Zi(t, 'textord', '\\nabla')) {
                    const e =
                            t.atoms[t.index].latex + t.atoms[t.index + 1].latex,
                        i = /^(>=|<=|>>|<<|:=|!=)$/.test(e) ? e : '';
                    return i && (t.index += 1), i;
                }
                return (
                    (t.index += 1),
                    Zi(t, 'mbin', '\\times')
        ...
        function os(t, e) {
            ...
            let i = (function t(e, i) {
                    if (
                        ...
                        return e;
                    let s = e.atoms[e.index];
                    if ('text' === s.mode) {
                        let t = '';
                        for (
                            ;
                            e.atoms[e.index] &&
                            'text' === e.atoms[e.index].mode;
                    ...
                    if (as(e)) e.ast = Xi(e.ast, t(e, i).ast);
                        ...
                        if ('root' === s.type)
                            return (e.index = 0), (e.atoms = s.body), t(e, i);
                        if ('mbin' === s.type && '-' === a)
                            (e.index += 1), ((e = t(e, i)).ast = Yi(e.ast));
                        else if ('mbin' === s.type && '+' === a)
                            (e.index += 1),
                                ((e = t(e, i)).ast = Xi('add', e.ast));
                        else if (
                            'mord' === s.type &&
                            /^[0-9.]$/.test(s.latex)
                        ) {
                            ...
                            for (
                                ...
                                (Zi(e, 'spacing') ||
                                    ((Zi(e, 'mord') ||
                                        Zi(e, 'mpunct', ',') ||
                                        Zi(e, 'mbin')) &&
                                        n.test(e.atoms[e.index].latex)));

                            )
                                if ('spacing' === e.atoms[e.index].type)
                                    e.index += 1;
                                else if (
                            ...
                            if (
                                ((e.ast = a ? Ji(a) : void 0),
                                (s = e.atoms[e.index]),
                                s && 'genfrac' === s.type && !isNaN(e.ast.num))
                            ) {
                                const s = e.ast;
                                (e = t(e, i)).ast = Xi('add', s, e.ast);
                            }
                            if (
                                s &&
                                'group' === s.type &&
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    if (-1 === Wi(e.ast.sup) && s[a])
                                        e.ast = Xi(s[a], t(e, i).ast);
                                    else {
                                        const s = e.ast;
                                        (s.arg = [t(e, i).ast]), (e.ast = s);
                                    }
                                } else {
                                    const s = e.ast,
                                        a = t(e, i).ast;
                            ...
                            (e.index += 1), (e.ast = s.toAST(i));
                        else if ('group' === s.type)
                            (e.index += 1), (e.ast = s.toAST(i));
                        else {
                            if ('mclose' === s.type) return e;
                            if ('error' === s.type)
                                return (
                                    (e.index += 1),
                                    (e.ast = { error: s.latex }),
                        ...
                        t
                            ...
                            : Pi(s) ||
                              ('placeholder' === s.type
                                  ...
                                  : ((e.ast = { text: '?' }),
                                    (e.ast.error =
                                        "Unexpected token '" + s.type + "'"),
                                    s.latex
                                        ? (e.ast.latex = s.latex)
                                        : s.body &&
                                          s.toLatex &&
                                          (e.ast.latex = s.toLatex())),
                              (e.index += 1));
                    }
                    if (
                        ((s = e.atoms[e.index]),
                        ...
                        if ('sizeddelim' === s.type)
                            for (const t in At.RIGHT_DELIM)
                                if (s.delim === At.RIGHT_DELIM[t])
                                    return (e.index += 1), e;
                        if (
                            ('mord' === s.type ||
                                'textord' === s.type ||
                        ...
                        (e.ast = {}),
                            (e = t(e, i)) && e.ast && a
                                ? (Ei(a.fn) && void 0 === a.arg) ||
                                  (Array.isArray(a.arg) && 0 === a.arg.length)
                                    ? 'list2' === e.ast.fn ||
                                      'list' === e.ast.fn
                                        ? (e.ast = Xi(a.fn, e.ast.arg))
                                        : (e.ast = Xi('multiply', a, e.ast))
                                    : 'multiply' === e.ast.fn
                                    ? e.ast.arg.unshift(a)
                                    : 0 === Ui(a) &&
                                      0 !== Vi(a) &&
                ...
                if (
                    ...
                    if (
                        ...
                        if (
                            ...
                            t.ast = {};
                            const s = ts(t, e).ast.sub;
                            if (
                                ((i = Xi('bind', i)),
                                s && 'equal' === s.fn && i.arg)
                            )
                                i.arg.push(Fi(s, 0)), i.arg.push(Fi(s, 1));
                            else if (
                                s &&
                                i.arg &&
                                ('list' === s.fn || 'list2' === s.fn)
                            ) {
                                let t = { sym: 'x' };
                                for (let e = 0; e < s.arg.length; e++)
                                    'equal' === s.arg[e].fn
                                        ? ((t = Fi(s.arg[e], 0)),
                                          i.arg.push(t),
                                          i.arg.push(Fi(s.arg[e], 1)))
                                        : (i.arg.push(t), i.arg.push(s.arg[e]));
                            } else
                                s && (i.arg.push({ sym: 'x' }), i.arg.push(s));
                        } else s = !0;
                    else {
                        const s = os(t, e).ast;
                        let o = Ri[a];
        ...
        function ns(t) {
            ...
            if (Array.isArray(t)) {
                ...
                'first' === t.type || 'box' === t.type
                    ? (e = ns(t.body))
                    : (t.body && Array.isArray(t.body) && (t.body = ns(t.body)),
                      t.superscript &&
                          Array.isArray(t.superscript) &&
                          (t.superscript = ns(t.superscript)),
                      t.subscript &&
                          Array.isArray(t.subscript) &&
                          (t.subscript = ns(t.subscript)),
                      t.index &&
                          Array.isArray(t.index) &&
                          (t.index = ns(t.index)),
                      t.denom &&
                          Array.isArray(t.denom) &&
                          (t.denom = ns(t.denom)),
                      t.numer &&
                          Array.isArray(t.numer) &&
                          (t.numer = ns(t.numer)),
                      t.array &&
                          Array.isArray(t.array) &&
                          (t.array = t.array.map(t => t.map(t => ns(t)))),
                      (e = [t]));
            }
            return e;
        }
        function rs(t, e) {
            return (function(t, e) {
                ...
                return i.length > 1 ? Xi('text', ...i) : i[0] || void 0;
            })({ atoms: ns(t) }, e);
        }
        function ls(t) {
        ...
        function cs(t, e) {
            ...
            for (let i = 0; i < t.length - 16; i++) {
                const s = t.substr(0, i);
                for (let a = 0; a < 17; a++) {
                    const o = t.substr(i, a + 1),
                        n = Math.floor((t.length - s.length) / o.length);
                    if (n > 1 && (s + o.repeat(n + 1)).startsWith(t))
                        return '0' === o
                            ? s.replace(/(\d{3})/g, '$1' + e.groupSeparator)
                            : s.replace(/(\d{3})/g, '$1' + e.groupSeparator) +
        ...
        function ds(t, e) {
                ...
                if ('number' != typeof t) {
                    ...
                    if (
                        ...
                        const a = t.match(/(\d*).(\d*)([e|E]([-+]?[0-9]*))?/),
                            ...
                            n = a[2].substring(
                                0,
                                Math.min(e.precision - o.length, a[2].length)
                            );
                        if (((s = a[4] || ''), '0' === o)) {
                            let s = 0;
                            for (; '0' === n[s] && s < n.length; ) s += 1;
                            let a = '';
                            if (s <= 4)
                                (a = '0' + e.decimalMarker),
                                    (a += n.substr(0, s)),
                                    (a += cs(t.substr(a.length), e));
                            else if (s + 1 >= e.precision) (a = '0'), (i = '');
                            else {
                                a = t[s];
                                const i = cs(t.substr(s + 1), e);
                                i && (a += e.decimalMarker + i);
                            }
                            '0' !== a &&
                            ...
                            const i = cs(n, e);
                            i && (t += e.decimalMarker + i);
                        }
                    } else if (t.length > e.precision) {
                        const i = t.length;
                        let s = t[0];
                        const a = cs(t.substr(2), e);
                        a &&
                            ((s += e.decimalMarker + a),
                            '}' !== s[s.length - 1] && (s += '\\ldots')),
                            '1' !== s ? (s += e.exponentProduct) : (s = ''),
                            e.exponentMarker
                                ? (s += e.exponentMarker + (i - 2).toString())
                                : (s += '10^{' + (i - 2).toString() + '}'),
                            (t = s);
                    } else
                        t = t.replace(
            ...
            if ('engineering' === e.scientificNotation)
                if (0 === t) i = '0';
                    ...
                    const s = Math.abs(t);
                    let a = Math.round(Math.log10(s));
                    (a -= a % 3), s < 1e3 && (a = 0);
                    let o = s / Math.pow(10, a);
                    const n = o.toString().match(/^(.*)\.(.*)$/);
                    n && n[1] && n[2] && (o = n[1] + e.decimalMarker + n[2]),
                        e.groupSeparator && (o = cs(o.toExponential(), e)),
                        (a =
                            0 === a
                                ? ''
                                : e.exponentMarker
                ...
                const s = 'string' == typeof t ? t : t.toString();
                let a,
                    o,
                    n,
                    r = s.match(/^(.*)[e|E]([-+]?[0-9]*)$/i);
                (a = s),
                    ...
                    r &&
                        ...
                        ((a = r[1]),
                        (o = e.exponentMarker
                            ? e.exponentMarker + r[2]
                            : e.exponentProduct + ' 10^{' + r[2] + '}')),
                    (r = a.match(/^(.*)\.(.*)$/)),
                    r && r[1] && r[2] && ((a = r[1]), (n = r[2])),
                    e.groupSeparator &&
                        ((a = a.replace(
                            /\B(?=(\d{3})+(?!\d))/g,
                            e.groupSeparator
        ...
        (te.MathAtom.prototype.toAST = function(t) {
            let e,
                i,
                s,
                a,
                ...
                l = {
                    ...
                    cmrss: 'sans-serif',
                    cmrtt: 'monospace',
                }[this.baseFontFamily || this.fontFamily],
                c = '';
            'b' === this.fontSeries && (c += 'bold'),
                'it' === this.fontShape && (c += 'italic');
            const h = this.latex ? this.latex.trim() : null;
            switch (this.type) {
                case 'root':
                case 'group':
                    this.latex && this.latex.startsWith('\\nicefrac')
                        ? ((e = this.latex
                              .slice(9)
                              .match(/({.*}|[^}])({.*}|[^}])/)),
                          e
                              ? ((i =
                                ...
                                (o = Xi('divide', rs(i, t), rs(s, t))))
                              : (o.fn = 'divide'))
                        : (o.group = rs(this.body, t));
                    break;
                case 'genfrac':
                    o = Xi(
                        'divide',
                ...
                case 'surd':
                    o = this.index
                        ? Xi(
                              'pow',
                              rs(this.body, t),
                              Xi('divide', Ji(1), rs(this.index, t))
                          )
                        : Xi('sqrt', rs(this.body, t));
                    break;
                case 'rule':
                    break;
                case 'line':
                        ...
                        e
                            ...
                            : ((r = qi(Ki(this))),
                              r.length > 0 &&
                                  ...
                                  'string' == typeof this.body &&
                                  (r = this.body)),
                        (a = At.mathVariantToUnicode(r, l, c)
                            .replace(/[\\]/g, '\\\\')
                            .replace(/["]/g, '\\"')
                            .replace(/[\b]/g, '\\b')
                            .replace(/[\f]/g, '\\f')
                ...
                case 'array':
                    if ('cardinality' === this.env.name)
                        o = Xi('card', rs(this.array, t));
                    else if (
                        /array|matrix|pmatrix|bmatrix/.test(this.env.name)
                    ) {
                        o = { fn: 'array', args: [] };
                        for (const e of this.array)
                            o.args.push(e.map(e => rs(e, t)));
                        ...
                        for (const e of this.array)
                            if (e[0]) {
                                ...
                                s &&
                                    'text' === s.fn &&
                                    s.arg &&
                                    /^(if|when|for)$/i.test(s.arg[0].trim()) &&
                                    (s = s.arg.filter(
                                        t => 'string' != typeof t
                                    )),
                                    i.push(s || {}),
            ...
            return (
                o && l && 'normal' !== l && (o.variant = l),
                o &&
                    'string' == typeof this.cssClass &&
                    (o.class = this.cssClass),
                o && 'string' == typeof this.cssId && (o.id = this.cssId),
                o
            );
        }),
            (te.toAST = function(t, e) {
                return rs(t, e);
            });
        var ps = function t(e, i) {
            ...
            let a = '';
            if (void 0 === e) return '';
            if (('string' == typeof e && (e = JSON.parse(e)), e.latex))
                a = e.latex;
            else if (Hi(e)) {
                const i = Wi(e);
                if (i === -1 / 0) a = '-\\infty ';
                else if (i === 1 / 0) a = '\\infty ';
                else if (
                    'object' != typeof e.num ||
                    ('string' != typeof e.num.re && 'string' != typeof e.num.im)
                )
                    a = isNaN(i) ? '\\text{NaN}' : ds(e.num, s);
                else {
                    const t = Vi(e),
                        i = Ui(e);
                    isNaN(t) || isNaN(i)
                        ...
                        ? (a = '0')
                        : (Math.abs(t) > Number.EPSILON && (a = ds(t, s)),
                          Math.abs(i) > Number.EPSILON &&
                              (Math.abs(t) > Number.EPSILON &&
                                  (a += i > 0 ? '+' : ''),
                              (a +=
                ...
                if ('bind' === e.fn) {
                    if (
                        ((a = t(Fi(e, 0), s) + '|_{'),
                        e.arg && 2 === e.arg.length)
                    )
                        a += t(Fi(e, 1));
                    else {
                        let i = '';
                        for (let s = 1; s < e.arg.length; s += 2)
                            (a += i + t(Fi(e, s)) + ' = ' + t(Fi(e, s + 1))),
                                (i = ', ');
                    }
                    a += '}';
                } else if ('divide' === e.fn)
                    a =
                        ...
                        t(Fi(e, 1), s) +
                        '}';
                else if ('negate' === e.fn) a = '-' + t(Fi(e, 0), s);
                else if ('subtract' === e.fn)
                    a = t(Fi(e, 0), s) + ' - ' + t(Fi(e, 1), s);
                else if (
                    ...
                    if ('list' === e.fn || 'list2' === e.fn) {
                        const i = [];
                        for (const a of e.arg) i.push(t(a, s));
                        a = i.join('list2' === e.fn ? '; ' : ', ');
                    } else if (
                        'pow' === e.fn &&
                        Array.isArray(e.arg) &&
                        ...
                        if (
                            ...
                            const n = t(Fi(e, 0), s),
                                ...
                                l = [...e.arg];
                            /%0/.test(i) &&
                                ((a = a.replace('%0', n)), l.shift()),
                                /%1/.test(i) &&
                                    ((a = a.replace('%1', r)), l.shift()),
                                l.length > 0 &&
                                    (o = ls(
                                        e.fence || '(),',
                                        ...l.map(e => t(e, s))
                    ...
                    if ('multiply' === e.fn)
                        a =
                            !e.arg ||
                            2 !== e.arg.length ||
                            (!Hi(e.arg[0]) && 'divide' !== e.arg[0].fn) ||
                            (Hi(e.arg[1]) &&
                                (0 !== Vi(e.arg[1]) || 1 !== Ui(e.arg[1])))
                                ? i.join(' \\times ')
                                : i[0] + i[1];
                    else if (e.arg && 1 === e.arg.length)
                        a =
                            'negate' === e.arg[0].fn ||
                            (Hi(e.arg[0]) && Wi(e.arg[0]) < 0)
                                ? i[0]
                                : '+' + i[0];
                    else {
                        a = i[0];
                ...
                i && i[1]
                    ...
                    : ((i = a.match(/^&#([0-9]+);$/i)),
                      i && i[1] && (a = String.fromCodePoint(parseInt(i[1])))),
        ...
        const ms = {
            ...
            '\\rceil':
                '<break time="150ms"/>close ceiling<break time="150ms"/>',
        ...
        function us(t) {
            ...
            if (t && Array.isArray(t))
                for (const i of t) 'first' !== i.type && (e += 1);
            return 1 === e;
        }
        function fs(t) {
            let e = '';
            ...
            for (const a of e) {
                ...
                if (e) {
                    ...
                    'active' === e[2] ? (a.passive = !1) : (a[e[2]] = !0),
                        t.addEventListener(e[1], i, a);
                } else t.addEventListener(a, i, s);
            }
        }
        function ys(t, e, i, s) {
            e = e.split(' ');
            for (const a of e) {
                ...
                if (e) {
                    const a = s || {};
                    'active' === e[2] ? (a.passive = !1) : (a[e[2]] = !0),
                        t.removeEventListener(e[1], i, a);
                } else t.removeEventListener(a, i, s);
            }
        }
        function bs(t, e) {
            ...
            return (
                i
                    ? i.setAttribute(
                          'data-refcount',
                          parseInt(i.getAttribute('data-refcount')) + 1
                      )
                    : ((i = document.createElement('div')),
                      i.setAttribute('aria-hidden', 'true'),
                      i.setAttribute('data-refcount', '1'),
                      (i.className = e),
                      (i.id = t),
        ...
        function xs(t) {
            ...
            return (
                e && 1 !== e
                    ? t.setAttribute('data-refcount', e - 1)
                    : t.remove(),
                t
            );
        }
        ...
        (te.toSpeakableFragment = function(t, e) {
            function i(t) {
            ...
            if (
                ...
                for (let n = 0; n < t.length; n++)
                    'text' !== t[n].mode && (o = !1),
                        ...
                        'mord' === t[n + 1].type
                            ? ((s += ' of '),
                              (s += i(te.toSpeakableFragment(t[n + 1], e))),
                              (n += 2))
                            : 'text' === t[n].mode
                            ? o
                                ? (s += t[n].body ? t[n].body : ' ')
                                : ((o = !0),
                                  (s += te.toSpeakableFragment(t[n], e)))
                            : 'mord' === t[n].type &&
                              /[0123456789,.]/.test(t[n].body)
                            ? a
                                ? (s += t[n].body)
                                : ((a = !0),
                                  (s += te.toSpeakableFragment(t[n], e)))
                ...
                switch (t.type) {
                    case 'group':
                    case 'root':
                        s += te.toSpeakableFragment(t.body, e);
                        break;
                    case 'genfrac':
                        if (
                            ((a = te.toSpeakableFragment(t.numer, e)),
                            (o = te.toSpeakableFragment(t.denom, e)),
                            us(t.numer) && us(t.denom))
                        ) {
                            const e = {
                                '1/2': ' half ',
                                '1/3': ' one third ',
                    ...
                    case 'surd':
                        if (
                            ((n = te.toSpeakableFragment(t.body, e)), t.index)
                        ) {
                            let i = te.toSpeakableFragment(t.index, e);
                            i = i.trim();
                            const a = i.replace(/<mark([^/]*)\/>/g, '');
                            s +=
                                '3' === a
                    ...
                    case 'accent':
                        break;
                    case 'leftright':
                        (s += ms[t.leftDelim] || t.leftDelim),
                            (s += te.toSpeakableFragment(t.body, e)),
                            (s += ms[t.rightDelim] || t.rightDelim);
                        break;
                    case 'line':
                    case 'rule':
                    case 'overunder':
                    ...
                    case 'textord': {
                        ...
                        if (
                            ...
                            } else s += te.toSpeakableFragment(t.body, e);
                            'mbin' === t.type && (s += '<break time="150ms"/>');
                        }
                        break;
                    }
                    case 'mop':
                        if ('​' !== t.body) {
                            const a = t.latex ? t.latex.trim() : '';
                            if ('\\sum' === a)
                                if (t.superscript && t.subscript) {
                                    let i = te.toSpeakableFragment(
                                        t.superscript,
                                        e
                                    );
                                    i = i.trim();
                                    let a = te.toSpeakableFragment(
                                        t.subscript,
                                        e
                                    );
                                    (a = a.trim()),
                                ...
                                if (t.superscript && t.subscript) {
                                    ...
                                    s +=
                                        ' the integral of <break time="200ms"/> ';
                        ...
                        break;
                    case 'enclose':
                        (n = te.toSpeakableFragment(t.body, e)),
                            us(t.body)
                                ? (s += ' crossed out ' + n + ' , ')
                                : (s +=
                                      ' crossed out ' + n + '. End cross out');
                }
                if (!r && t.superscript) {
                    let i = te.toSpeakableFragment(t.superscript, e);
                    i = i.trim();
                    const a = i.replace(/<[^>]*>/g, '');
                    if (us(t.superscript)) {
                ...
                if (!r && t.subscript) {
                    let i = te.toSpeakableFragment(t.subscript, e);
                    (i = i.trim()),
                        us(t.subscript)
                            ? (s += ' sub ' + i)
                            : (s += ' subscript ' + i + '. End subscript. ');
                }
            }
            return s;
        }),
            (te.toSpeakableText = function(t, e) {
                const i = e
                    ? JSON.parse(JSON.stringify(e))
                    : { textToSpeechMarkup: '', textToSpeechRules: 'mathlive' };
                if (
                    ((i.speechMode = 'math'),
                    window.sre && 'sre' === i.textToSpeechRules)
                ) {
                    i.generateID = !0;
                    const e = te.toMathML(t, i);
                    return e
                        ? (i.textToSpeechMarkup &&
                              ((i.textToSpeechRulesOptions =
                                  i.textToSpeechRulesOptions || {}),
                              (i.textToSpeechRulesOptions.markup =
                                  i.textToSpeechMarkup),
                              'ssml' === i.textToSpeechRulesOptions.markup &&
                                  (i.textToSpeechRulesOptions.markup =
                                      'ssml_step'),
                              (i.textToSpeechRulesOptions.rate =
                                  i.speechEngineRate)),
                          i.textToSpeechRulesOptions &&
                ...
                let s = te.toSpeakableFragment(t, i);
                if ('ssml' === i.textToSpeechMarkup) {
                    let t = '';
                    i.speechEngineRate &&
                        (t = '<prosody rate="' + i.speechEngineRate + '">'),
                        (s =
        ...
        class vs {
            constructor(t, e) {
                ...
                this.config.substituteTextArea
                    ...
                    'manual' === this.config.virtualKeyboardMode
                        ? ((s += `<button class="ML__virtual-keyboard-toggle" data-tooltip="${Qe(
                              'tooltip.toggle virtual keyboard'
                          )}">`),
                          this.config.virtualKeyboardToggleGlyph
                              ? (s += this.config.virtualKeyboardToggleGlyph)
                              : (s +=
                ...
                'function' == typeof this.config.substituteTextArea
                    ...
                    (this.accessibleNode = this.element.children[
                        a++
                    ].children[1]),
                    (this.popover = bs(
                    ...
                    (this.style = {}),
                    (this.blurred = !0),
                    gs(this.element, 'focus', this),
                    gs(this.element, 'blur', this),
                    gs(this.textarea, 'cut', this),
                    gs(this.textarea, 'copy', this),
                    gs(this.textarea, 'paste', this),
                    He.delegateKeyboardEvents(this.textarea, {
                    ...
                    window.PointerEvent
                        ? gs(this.field, 'pointerdown', this)
                        : gs(this.field, 'touchstart:active mousedown', this),
                    gs(window, 'resize', this);
                const o = { ...e };
                (o.onSelectionDidChange = vs.prototype._onSelectionDidChange.bind(
                    this
                )),
                    (o.onContentDidChange = vs.prototype._onContentDidChange.bind(
                        this
                    )),
                    ...
                    (this.undoManager = new (class {
                        ...
                        undo(t) {
                            this.canUndo() &&
                                (t &&
                                    'function' ==
                                        typeof t.onUndoStateWillChange &&
                                    t.onUndoStateWillChange(
                                        this.mathlist.target,
                                        'undo'
                                    ),
                                ...
                                t &&
                                    'function' ==
                                        typeof t.onUndoStateDidChange &&
                                    t.onUndoStateDidChange(
                                        this.mathlist.target,
                                        'undo'
                                    ),
                                (this.canCoalesce = !1));
                        ...
                        snapshot(t) {
                            this.record &&
                                ...
                                this.index++,
                                this.stack.length > this.maximumDepth &&
                                    this.stack.shift(),
                                t &&
                                    'function' ==
                                        typeof t.onUndoStateDidChange &&
                        ...
                        restore(t, e) {
                            const i = this.mathlist.suppressChangeNotifications;
                            void 0 !== e.suppressChangeNotifications &&
                                ...
                                (this.mathlist.suppressChangeNotifications = i);
                        }
                    })(this.mathlist)),
                    i.length > 0 && this.$latex(i),
            ...
            $revertToOriginalContent() {
                (this.element.innerHTML = this.originalContent),
                    ...
                    delete this.field,
                    ys(this.textarea, 'cut', this),
                    ys(this.textarea, 'copy', this),
                    ys(this.textarea, 'paste', this),
                    this.textarea.remove(),
                    delete this.textarea,
                    this.virtualKeyboardToggleDOMNode.remove(),
                    delete this.virtualKeyboardToggleDOMNode,
                    xs(this.popover),
                    xs(this.keystrokeCaption),
                    xs(this.virtualKeyboard),
                    xs(
                        document.getElementById('mathlive-alternate-keys-panel')
                    ),
                    ys(this.element, 'pointerdown', this),
                    ys(this.element, 'touchstart:active mousedown', this),
                    ys(this.element, 'focus', this),
                    ys(this.element, 'blur', this),
                    ys(window, 'resize', this),
                    delete this.element;
            }
            ...
            _getCaretPosition() {
                ...
                if (t) {
                    ...
                    return { x: e.right, y: e.bottom, height: e.height };
                }
                return null;
            }
            _getSelectionBounds() {
                ...
                if (t && t.length > 0) {
                    ...
                    const i = this.field.getBoundingClientRect(),
                        s = e.right - e.left,
                        a = e.bottom - e.top;
                    return (
                        (e.left = Math.ceil(
                            e.left - i.left + this.field.scrollLeft
                        )),
                        (e.right = e.left + s),
                        (e.top = Math.ceil(e.top - i.top)),
                        (e.bottom = e.top + a),
                        e
                    );
                }
                ...
                const a = (function t(e, i, s) {
                        ...
                        if (e.getAttribute('data-atom-id')) {
                            ...
                            const t = e.getBoundingClientRect(),
                                n = i - (t.left + t.right) / 2,
                                r = s - (t.top + t.bottom) / 2;
                            (a.distance = n * n + r * r),
                                (o = i >= t.left && i <= t.right);
                        }
                        return (
                            o &&
                                e.children &&
                    ...
                    o = a ? a.getAttribute('data-atom-id') : null;
                if (o) {
                    const e = this.mathlist.filter(function(t, e) {
                        return e.captureSelection
                            ? e.filter(t => t.id === o).length > 0
                            : e.id === o;
                    });
                    if (e && e.length > 0)
                        if (
                            ((s = me.pathFromString(e[0]).path), 0 === i.bias)
                        ) {
                            const e = a.getBoundingClientRect();
                            t < e.left + e.width / 2 &&
                                !a.classList.contains('ML__placeholder') &&
                                (s[s.length - 1].offset = Math.max(
                                    0,
                                    s[s.length - 1].offset - 1
                                ));
                        } else
                            i.bias < 0 &&
                                (s[s.length - 1].offset = Math.min(
                                    this.mathlist.siblings().length - 1,
                                    Math.max(0, s[s.length - 1].offset + i.bias)
                                ));
                }
                return s;
            }
            _onPointerDown(t) {
                ...
                function n(t) {
                    window.PointerEvent
                        ...
                        : (ys(e.field, 'touchmove', h),
                          ys(e.field, 'touchend touchleave', n),
                          ys(window, 'mousemove', h),
                          ys(window, 'mouseup blur', n)),
                        (s = !1),
                        clearInterval(c),
                        e.element
                ...
                function h(t) {
                    ...
                    const c = e.field.getBoundingClientRect();
                    (l = s > c.right), (r = s < c.left);
                    let h = i;
                    window.PointerEvent
                        ? t.isPrimary ||
                          (h = e._pathFromPoint(t.clientX, t.clientY, {
                              bias: 0,
                          }))
                        : t.touches &&
                          2 === t.touches.length &&
                    ...
                    const u = e._pathFromPoint(s, o, {
                        bias: s <= d ? (s === d ? 0 : -1) : 1,
                    });
                    u &&
                        e.mathlist.setRange(h, u, {
                ...
                const d = t.touches ? t.touches[0].clientX : t.clientX,
                    p = t.touches ? t.touches[0].clientY : t.clientY,
                    m = Date.now();
                ws &&
                Math.abs(ws.x - d) < 5 &&
                Math.abs(ws.y - p) < 5 &&
                Date.now() < ws.time + 500
                    ? ((Ss += 1), (ws.time = m))
                    : ((ws = { x: d, y: p, time: m }), (Ss = 1));
                ...
                if (
                    ...
                    if (
                        ...
                        (this.smartModeSuppressed = !1),
                        (i = this._pathFromPoint(d, p, { bias: 0 })),
                        i)
                    ) {
                        let r = document.createElement('div');
                        (r.className = 'ML__scroller'),
                            this.element.appendChild(r),
                            (r.style.left = u.left - 200 + 'px'),
                            (r = document.createElement('div')),
                            (r.className = 'ML__scroller'),
                            this.element.appendChild(r),
                            (r.style.left = u.right + 'px'),
                            t.shiftKey
                                ? (this.mathlist.setRange(
                                      this.mathlist.path,
                                      i
                                  ),
                                  (i = me.clone(this.mathlist.path)),
                                  (i[i.length - 1].offset -= 1))
                                : this.mathlist.setPath(i, 0),
                            (o = !0),
                            (this.style = {}),
                            3 === t.detail || Ss > 2
                                ? (n(t),
                                ...
                                : s ||
                                  ...
                                  window.PointerEvent
                                      ...
                                      : (gs(window, 'blur', n),
                                        t.touches
                                            ? (gs(t.target, 'touchmove', h),
                                              gs(t.target, 'touchend', n))
                                            : (gs(window, 'mousemove', h),
                                              gs(window, 'mouseup', n))),
                                  (2 !== t.detail && 2 !== Ss) ||
                                      ((a = !0), this.mathlist.selectGroup_()));
                    }
                } else ws = null;
                o && this._requestUpdate(), t.preventDefault();
            }
            _onSelectionDidChange() {
                this.mathlist.commitCommandStringBeforeInsertionPoint();
                let t = '';
                this.mathlist.forEachSelected(e => {
                    t += e.toLatex();
                }),
                    t
                          ...
                          this.textarea.setAttribute('aria-label', ''));
                {
                    const t = this.mode;
                    (this.mode =
                        this.mathlist.anchorMode() || this.config.defaultMode),
                        this.mode !== t &&
                ...
                Je.updatePopoverPosition(this, { deferred: !0 }),
                    'function' == typeof this.config.onSelectionDidChange &&
            ...
            _nextAtomSpeechText(t) {
                ...
                const i = t ? t.path : [],
                    s = this.mathlist.path,
                    a = s[s.length - 1];
                let o = '';
                for (; i.length > s.length; )
                    (o += 'out of ' + e(t.parent(), i[i.length - 1]) + '; '),
                        i.pop();
                if (!this.mathlist.isCollapsed())
                    return As(this, '', this.mathlist.getSelectedAtoms());
                const n = e(this.mathlist.parent(), a);
                0 === a.offset &&
                    (o += (n ? 'start of ' + n : 'unknown') + ': ');
                const r = this.mathlist.sibling(
                    Math.max(1, this.mathlist.extent)
                );
                return (
                    r
                        ? (o += As(this, '', r))
                        : 0 !== a.offset &&
                          (o += n ? 'end of ' + n : 'unknown'),
                    o
                );
            }
            _announce(t, e, i) {
            ...
            convertLastAtomsToText_(t, e) {
                ...
                let i = 0,
                    s = !1;
                for (this.mathlist.contentWillChange(); !s; ) {
                    const a = this.mathlist.sibling(i);
                    (s =
                        0 === t ||
                        !a ||
                        'math' !== a.mode ||
            ...
            convertLastAtomsToMath_(t, e) {
                ...
                for (; !s; ) {
                    ...
                    (s =
                        ...
                        ' ' === a.body ||
                        (e && !e(a))),
                        s || a.applyStyle({ mode: 'math', type: 'mord' }),
                        (i -= 1),
                        (t -= 1);
                }
            ...
            removeIsolatedSpace_() {
                ...
                for (
                    ...
                    'math' === this.mathlist.sibling(t).mode;
                ...
                if (
                    ...
                    (this.mathlist.suppressChangeNotifications = !0),
                        this.mathlist.setSelection(
                            this.mathlist.anchorOffset() - 1
                        ),
            ...
            getTextBeforeAnchor_() {
                let t = '',
                    ...
                    i = !1;
                for (; !i; ) {
                    const s = this.mathlist.sibling(e);
                    (i = !(
                        s &&
                        (('text' === s.mode && !s.type) ||
                            ('math' === s.mode &&
                                /mord|textord|mpunct/.test(s.type)))
                    )),
                        i || (t = s.body + t),
                        (e -= 1);
                }
            ...
            smartMode_(t, e) {
                ...
                if (
                    this.mathlist.endOffset() <
                    this.mathlist.siblings().length - 1
                )
                    return !1;
                if (!e || e.ctrlKey || e.metaKey) return !1;
                const i = He.eventToChar(e);
                if (i.length > 1) return !1;
                if (!this.mathlist.isCollapsed())
                    return !('text' !== this.mode || !/[/_^]/.test(i));
                const s = this.getTextBeforeAnchor_() + i;
                if ('text' === this.mode) {
                    if ('Esc' === t || /[/\\]/.test(i)) return !0;
                    if (/[\^_]/.test(i))
                        return (
                            /(^|\s)[a-zA-Z][^_]$/.test(s) &&
                    ...
                    if (/[0-9+\-=><*|]$/.test(i))
                        return this.removeIsolatedSpace_(), !0;
                } else {
                    if ('Spacebar' === t)
                        return (
            ...
            _onKeystroke(t, e) {
                if (
                    ...
                    this.config.onKeystroke &&
                        !this.config.onKeystroke(this, t, e))
                )
                    return (
                        e &&
                            e.preventDefault &&
                    ...
                    if ('Backspace' !== t)
                        if (!t || t.length > 1) this._resetKeystrokeBuffer();
                            ...
                            (s = a - 1),
                                ...
                                this.keystrokeBufferStates.push(
                                    this.undoManager.save()
                                ),
                                ve.startsWithString(e, this.config).length <= 1
                                    ? (o = !0)
                ...
                if (
                    (i || a || (a = ve.selectorForKeystroke(this.mode, t)),
                    !i && !a)
                )
                    return !0;
                ...
                if (((a && !this.$perform(a)) || i) && i) {
                    if (
                        ...
                        this.mathlist.insert(He.eventToChar(e), {
                    ...
                    this.mathlist.suppressChangeNotifications = !0;
                    const a = { ...this.mathlist.anchorStyle(), ...this.style };
                    this.mathlist.insert(i, {
                        format: 'latex',
                        mode: this.mode,
                        style: a,
                        smartFence: !0,
            ...
            _onTypedText(t, e) {
                ...
                if (
                    ...
                    const e = t.charAt(0),
                        i = He.charToEvent(e);
                    if (!this.$keystroke(He.keyboardEventToString(i), i))
                        return;
                }
                let i = '',
                    a = !1;
                if (this.pasteInProgress)
                    ...
                    const e = { ...this.mathlist.anchorStyle(), ...this.style },
                        o = s(t);
                    for (const t of o)
                ...
                'command' !== this.mode &&
                    ...
                    this._requestUpdate(),
                    this.scrollIntoView(),
                    Je.showPopoverWithLatex(this, i, a);
            }
            _hash() {
                let t = 0;
                const e = this.mathlist.root.toLatex(!1);
                for (let i = 0; i < e.length; i++)
                    (t = 31 * t + e.charCodeAt(i)), (t |= 0);
                return Math.abs(t);
            }
            _requestUpdate() {
                this.dirty ||
                    ((this.dirty = !0),
                    requestAnimationFrame(t => ks(this) && this._render()));
            }
            _render(t) {
                (t = t || {}),
                    (this.dirty = !1),
                ...
                (this.field.innerHTML = n.toMarkup(
                    ...
                    (this.accessibleNode.innerHTML =
                        ...
                        '</math>');
                const r = this._getSelectionBounds();
                if (r) {
                    ...
                    t.classList.add('ML__selection'),
                        ...
                        (t.style.width = Math.ceil(r.right - r.left) + 'px'),
                        (t.style.height =
                            Math.ceil(r.bottom - r.top - 1) + 'px'),
            ...
            formatMathlist(t, e) {
                ...
                if ('latex' === (e = e || 'latex') || 'latex-expanded' === e)
                    i = t.toLatex('latex-expanded' === e);
                else if ('mathML' === e) i = t.toMathML(this.config);
                else if ('spoken' === e) i = te.toSpeakableText(t, this.config);
                else if ('spoken-text' === e) {
                    const e = this.config.textToSpeechMarkup;
                    (this.config.textToSpeechMarkup = ''),
                        (i = te.toSpeakableText(t, this.config)),
                        (this.config.textToSpeechMarkup = e);
                } else if (
                    'spoken-ssml' === e ||
                    'spoken-ssml-withHighlighting' === e
                ) {
                    const s = this.config.textToSpeechMarkup,
                        a = this.config.generateID;
                    (this.config.textToSpeechMarkup = 'ssml'),
                        'spoken-ssml-withHighlighting' === e &&
                            (this.config.generateID = !0),
                        (i = te.toSpeakableText(t, this.config)),
                        (this.config.textToSpeechMarkup = s),
                        (this.config.generateID = a);
                } else if ('json' === e) {
                    const e = te.toAST(t, this.config);
                    i = JSON.stringify(e);
                } else
                    'ASCIIMath' === e &&
                        (i = (function t(e, i) {
                            ...
                            if (Array.isArray(e)) {
                                ...
                                if (
                                    ...
                                    let s = 0;
                                    for (; e[s] && 'math' === e[s].mode; )
                                        (i += t(e[s])), s++;
                                    i += t(e.slice(s));
                                }
                                return i.trim();
                            }
                            if ('text' === e.mode) return '"' + e.body + '"';
                            let s = '';
                            const a = e.latex ? e.latex.trim() : null;
                            let o;
                            switch (e.type) {
                                case 'group':
                                case 'root':
                            ...
                            if (e.subscript) {
                                s += '_';
                                const i = t(e.subscript);
                                i.length > 1 && !/^(-)?\d+(\.\d*)?$/.test(i)
                                    ? (s += '(' + i + ')')
                                    : (s += i);
                            }
                            if (e.superscript) {
                                s += '^';
                                const i = t(e.superscript);
                                i.length > 1 && !/^(-)?\d+(\.\d*)?$/.test(i)
                                    ? (s += '(' + i + ')')
                                    : (s += i);
                            }
            ...
            $selectedText(t) {
                ...
                if (!e) return '';
                const i = te.makeRoot('math', e);
                return this.formatMathlist(i, t);
            }
            ...
            _superscriptDepth() {
                let t = 0,
                    e = 0,
                    i = this.mathlist.ancestor(e),
                    s = !1;
                for (; i; )
                    (i.superscript || i.subscript) && (t += 1),
                        i.superscript ? (s = !0) : i.subscript && (s = !1),
                        (e += 1),
                        (i = this.mathlist.ancestor(e));
                return s ? t : 0;
            }
            _subscriptDepth() {
                ...
                for (; i; )
                    (i.superscript || i.subscript) && (t += 1),
                        i.superscript ? (s = !1) : i.subscript && (s = !0),
                        (e += 1),
                        (i = this.mathlist.ancestor(e));
                return s ? t : 0;
            }
            ...
            scrollIntoView() {
                ...
                if (!t) {
                    const i = this._getSelectionBounds();
                    i &&
                        (t = {
                            x: i.right + e.left - this.field.scrollLeft,
                            y: i.top + e.top - this.field.scrollTop,
                        });
                }
                if (t) {
                    const i = t.x - window.scrollX;
                    i < e.left
                        ? this.field.scroll({
                              top: 0,
                              left: i - e.left + this.field.scrollLeft - 20,
                              behavior: 'smooth',
                          })
                        : i > e.right &&
                          this.field.scroll({
                              top: 0,
                              left: i - e.right + this.field.scrollLeft + 20,
                              behavior: 'smooth',
                          });
                }
            }
            ...
            switchMode_(t, e, i) {
                this._resetKeystrokeBuffer(),
                    ...
                    'command' === t
                        ...
                        : (this.mode = t),
                    i && this.$insert(i, { format: 'latex', mode: t }),
                    'function' == typeof this.config.onModeChange &&
                        this.config.onModeChange(this, this.mode),
                    this._requestUpdate();
            }
            complete_(t) {
                if (((t = t || {}), Je.hidePopover(this), t.discard))
                    return (
            ...
            _updateSuggestion() {
                ...
                if (0 === e.length)
                    ...
                    const i = this.suggestionIndex % e.length,
                        s = t.length - e[i].match.length;
                    0 !== s && this.mathlist.insertSuggestion(e[i].match, s),
                        Je.showPopoverWithLatex(this, e[i].match, e.length > 1);
                }
                this._requestUpdate();
            }
            nextSuggestion_() {
                return (
                    (this.suggestionIndex += 1), this._updateSuggestion(), !1
                );
            }
            previousSuggestion_() {
                if (((this.suggestionIndex -= 1), this.suggestionIndex < 0)) {
                    ...
                    const t = this.mathlist.extractCommandStringAroundInsertionPoint(),
                        e = At.suggest(t);
                    this.suggestionIndex = e.length - 1;
                }
            ...
            _attachButtonHandlers(t, e) {
                ...
                'object' == typeof e && (e.default || e.pressed)
                    ...
                    gs(t, 'mousedown touchstart:passive', function(e) {
                        if ('mousedown' !== e.type || 1 === e.buttons) {
                            ...
                            const n = t.getAttribute(
                                'data-' + i.config.namespace + 'command-pressed'
                            );
                            n && i.$perform(JSON.parse(n));
                            ...
                            l &&
                                ...
                                (r = window.setTimeout(function() {
                                    t.classList.contains('pressed') &&
                                        i.$perform(JSON.parse(l));
                                }, 300)));
                        }
                    }),
                    gs(t, 'mouseleave touchcancel', function() {
                        t.classList.remove('pressed');
                    }),
                    gs(t, 'touchmove:passive', function(t) {
                        t.preventDefault();
                    ...
                    gs(t, 'mouseenter', function(e) {
                        1 === e.buttons && t.classList.add('pressed');
                    }),
                    gs(t, 'mouseup touchend click', function(e) {
                        if (n) {
                        ...
                        let o = t.getAttribute(
                            'data-' +
                                i.config.namespace +
                                'command-pressAndHoldEnd'
                        );
                        const r = Date.now();
                        (t !== a || r < s + 300) && (o = void 0),
                            !o &&
                                e.altKey &&
                                e.shiftKey &&
                                (o = t.getAttribute(
                            ...
                            !o &&
                                e.altKey &&
                                (o = t.getAttribute(
                                    'data-' + i.config.namespace + 'command-alt'
                                )),
                            !o &&
                                e.shiftKey &&
                                (o = t.getAttribute(
                            ...
                            o ||
                                (o = t.getAttribute(
                                    'data-' + i.config.namespace + 'command'
                                )),
                            o && i.$perform(JSON.parse(o)),
                            e.stopPropagation(),
                            e.preventDefault();
                    });
            }
            _makeButton(t, e, i, s) {
                ...
                return (
                    ...
                    this._attachButtonHandlers(a, s),
                    a
                );
            }
            showAlternateKeys_(t, e) {
                ...
                if (a) {
                    a.top - i.clientHeight < 0 &&
                        ((i.style.width = 'auto'),
                        e.length <= 6
                            ? (i.style.height = '56px')
                            : e.length <= 12
                            ? (i.style.height = '108px')
                            : (i.style.height = '205px'));
                    const t = (a.top - i.clientHeight + 5).toString() + 'px',
                        s =
                            Math.max(
                                0,
                                Math.min(
                                    window.innerWidth - i.offsetWidth,
                                    (a.left + a.right - i.offsetWidth) / 2
                                )
                            ) + 'px';
            ...
            switchKeyboardLayer_(t) {
                if ('off' !== this.config.virtualKeyboardMode) {
                    ...
                    const e = this.virtualKeyboard.getElementsByClassName(
                        'keyboard-layer'
                    );
                    let i = !1;
                    for (let s = 0; s < e.length; s++)
                        if (e[s].dataset.layer === t) {
                            i = !0;
                            break;
                        }
                    if (i)
                        for (let i = 0; i < e.length; i++)
                            e[i].dataset.layer === t
                                ? e[i].classList.add('is-visible')
                                : e[i].classList.remove('is-visible');
                    this.$focus();
                }
                return !0;
            }
            shiftKeyboardLayer_() {
                ...
                if (t)
                    for (let e = 0; e < t.length; e++) {
                        const i = t[e];
                        let s = i.getAttribute('data-shifted');
                        if (s || /^[a-z]$/.test(i.innerHTML)) {
                            i.setAttribute(
                                'data-unshifted-content',
                                i.innerHTML
                            ),
                                s || (s = i.innerHTML.toUpperCase()),
                                (i.innerHTML = s);
                            const t = i.getAttribute(
                                'data-' + this.config.namespace + 'command'
                            );
                            if (t) {
                                i.setAttribute('data-unshifted-command', t);
                                const e = i.getAttribute(
                                    'data-shifted-command'
                                );
                                if (e)
                                    i.setAttribute(
            ...
            unshiftKeyboardLayer_() {
                ...
                if (t)
                    for (let e = 0; e < t.length; e++) {
                        const i = t[e],
                            s = i.getAttribute('data-unshifted-content');
                        s && (i.innerHTML = s);
                        const a = i.getAttribute('data-unshifted-command');
                        a &&
                            i.setAttribute(
                                'data-' + this.config.namespace + 'command',
                                a
            ...
            toggleVirtualKeyboardAlt_() {
                ...
                return (
                    this.virtualKeyboard &&
                        ((t = this.virtualKeyboard.classList.contains(
                            'material'
                        )),
            ...
            showVirtualKeyboard_(t) {
                return (
                    (this.virtualKeyboardVisible = !1),
                    this.toggleVirtualKeyboard_(t),
                    !1
                );
            }
            hideVirtualKeyboard_() {
                return (
                    (this.virtualKeyboardVisible = !0),
            ...
            toggleVirtualKeyboard_(t) {
                if (
                    ((this.virtualKeyboardVisible = !this
                        .virtualKeyboardVisible),
                    this.virtualKeyboardVisible)
                ) {
                    this.virtualKeyboard
                        ? this.virtualKeyboard.classList.add('is-visible')
                        : ((this.virtualKeyboard = ci.make(this, t)),
                          gs(
                              this.virtualKeyboard,
                    ...
                    const e = this;
                    window.setTimeout(function() {
                        e.virtualKeyboard.classList.add('is-visible');
                    }, 1);
                } else
                    this.virtualKeyboard &&
                ...
                if (
                    ...
                    (t = (function(t) {
                        ...
                        return (
                            ...
                            'string' == typeof t.series &&
                                (e.fontSeries = t.series),
                            'string' == typeof t.fontSeries &&
                                (e.fontSeries = t.fontSeries.toLowerCase()),
                            e.fontSeries &&
                                (e.fontSeries =
                                    { bold: 'b', medium: 'm', normal: 'mn' }[
                                        e.fontSeries
                                    ] || e.fontSeries),
                    ...
                    if (this.mathlist.isCollapsed()) this.switchMode_(t.mode);
                        ...
                        const t = this.mode,
                            e =
                                'math' ===
                                (this.mathlist.anchorMode() ||
                                    this.config.default)
                                    ? 'text'
                                    : 'math';
                        let i = this.$selectedText('ASCIIMath');
                        if (
                            ('math' === e &&
                                /^"[^"]+"$/.test(i) &&
                                (i = i.slice(1, -1)),
            ...
            $setConfig(t) {
                ...
                if (
                    ...
                    (this.config.onAnnounce = t.onAnnounce || Ms),
                ...
                /-$/.test(this.config.namespace) ||
                    (this.config.namespace += '-'),
                    (Qe.locale = this.config.locale || Qe.locale),
                    Qe.merge(this.config.strings),
                    (this.config.virtualKeyboardLayout =
            ...
            speak_(t, e) {
                ...
                const i = (function(t, e) {
                    ...
                    switch (e) {
                        case 'all':
                            ...
                            break;
                        case 'selection':
                            t.mathlist.isCollapsed() ||
                                (i = t.mathlist.getSelectedAtoms());
                            break;
                        case 'left': {
                            const e = t.mathlist.siblings(),
                                s = t.mathlist.startOffset();
                            if (s >= 1) {
                                i = [];
                                for (let t = 1; t <= s; t++) i.push(e[t]);
                            }
                            break;
                        }
                        case 'right': {
                            const e = t.mathlist.siblings(),
                                s = t.mathlist.endOffset() + 1;
                            if (s <= e.length - 1) {
                                i = [];
                                for (let t = s; t <= e.length - 1; t++)
                                    i.push(e[t]);
                            }
                            break;
                        }
                        ...
                        case 'end':
                            break;
                        case 'group':
                            i = t.mathlist.siblings();
                            break;
                        case 'parent': {
                            const e = t.mathlist.parent();
                            e && 'root' !== e.type && (i = t.mathlist.parent());
                            break;
                        }
                    }
                    return i;
                ...
                const s = { ...this.config };
                (e.withHighlighting || 'amazon' === s.speechEngine) &&
                    ((s.textToSpeechMarkup =
                        window.sre && 'sre' === s.textToSpeechRules
                            ? 'ssml_step'
                            : 'ssml'),
                    e.withHighlighting && (s.generateID = !0));
                const a = te.toSpeakableText(i, s);
                return (
                    e.withHighlighting
                        ? ((window.mathlive.readAloudMathField = this),
                          this._render({ forHighlighting: !0 }),
        ...
        let ws,
            Ss = 0;
        function As(t, e, i) {
            const s = Object.assign({}, t.config);
            return (
                (s.textToSpeechMarkup = ''),
                (s.textToSpeechRulesOptions = s.textToSpeechRulesOptions || {}),
                (s.textToSpeechRulesOptions.markup = 'none'),
                e + te.toSpeakableText(i, s)
            );
        }
        function Ms(t, e, i, s) {
            let a = '';
            'plonk' === e
                ...
                ? (a =
                      ...
                      t._nextAtomSpeechText(i))
                : 'replacement' === e
                ? (a = As(t, '', t.mathlist.sibling(0)))
                : 'line' === e
                ? ((a = As(t, '', t.mathlist.root)),
                  (t.accessibleNode.innerHTML =
                      '<math xmlns="http://www.w3.org/1998/Math/MathML">' +
                      te.toMathML(t.mathlist.root, t.config) +
                      '</math>'),
                  t.textarea.setAttribute('aria-label', 'after: ' + a))
                : (a = s ? As(t, e + ' ', s) : e);
            const o = /\u00a0/.test(t.ariaLiveText.textContent) ? '   ' : '   ';
            t.ariaLiveText.textContent = a + o;
        }
        (vs.prototype.undo_ = vs.prototype.undo),
            (vs.prototype.redo_ = vs.prototype.redo),
            (vs.prototype.scrollIntoView_ = vs.prototype.scrollIntoView),
            (vs.prototype.scrollToStart_ = vs.prototype.scrollToStart),
            (vs.prototype.scrollToEnd_ = vs.prototype.scrollToEnd),
            (vs.prototype.insert_ = vs.prototype.$insert);
        var Cs = { isValidMathfield: ks, MathField: vs };
        function _s(t, e, i) {
            let s = i,
                a = 0;
            const o = t.length;
            for (; s < e.length; ) {
                const i = e[s];
                if (a <= 0 && e.slice(s, s + o) === t) return s;
                '\\' === i ? s++ : '{' === i ? a++ : '}' === i && a--, s++;
            }
            return -1;
        }
                ...
                if ('text' === t[o].type) {
                    ...
                    (r = n.indexOf(e)),
                        -1 !== r &&
                            ((c = r),
                            c > 0 &&
                                a.push({ type: 'text', data: n.slice(0, c) }),
                            (l = !1));
                    let h = !1;
                    for (; !h; ) {
                        if (l) {
                            if (((r = n.indexOf(e, c)), -1 === r)) {
                                h = !0;
                                break;
                            }
                            c !== r &&
                                a.push({ type: 'text', data: n.slice(c, r) }),
                                (c = r);
                        } else {
                            if (((r = _s(i, n, c + e.length)), -1 === r)) {
                                h = !0;
                                break;
                            }
                            a.push({
                                type: 'math',
                                data: n.slice(c + e.length, r),
                                rawData: n.slice(c, r + i.length),
                                mathstyle: s,
                            }),
                                (c = r + i.length);
                        }
                    ...
                    c < n.length && a.push({ type: 'text', data: n.slice(c) });
                } else a.push(t[o]);
            return a;
        }
        function Ls(t, e) {
            let i = [{ type: 'text', data: t }];
            for (let t = 0; t < e.inline.length; t++) {
                const s = e.inline[t];
                i = Ts(i, s[0], s[1], 'textstyle');
            }
            for (let t = 0; t < e.display.length; t++) {
                const s = e.display[t];
                i = Ts(i, s[0], s[1], 'displaystyle');
            }
            return i;
        }
        function Fs(t, e, i, s) {
            const a = (function(t, e, i, s) {
                ...
                a.setAttribute('aria-hidden', 'true'),
                    e.preserveOriginalContent &&
                        ...
                        i &&
                            a.setAttribute(
                                'data-' + e.namespace + 'original-mathstyle',
                                i
                            ));
                try {
                    a.innerHTML = e.renderToMarkup(
                        t,
                        i || 'displaystyle',
                        'html',
                        e.macros
            ...
            if (
                a &&
                /\b(mathml|speakable-text)\b/i.test(i.renderAccessibleContent)
            ) {
                const e = document.createDocumentFragment();
                if (
                    (/\bmathml\b/i.test(i.renderAccessibleContent) &&
                        i.renderToMathML &&
                        e.appendChild(
                            (function(t, e) {
                                ...
                                return (i.className = 'sr-only'), i;
                            })(t, i)
                        ),
                    /\bspeakable-text\b/i.test(i.renderAccessibleContent) &&
                        i.renderToSpeakableText)
                ) {
                    const s = document.createElement('span');
                    (s.innerHTML = i.renderToSpeakableText(t, i)),
                        (s.className = 'sr-only'),
                        e.appendChild(s);
                }
        ...
        function Ds(t, e) {
            ...
            if (e.TeX.processEnvironments && /^\s*\\begin/.test(t))
                (i = document.createDocumentFragment()),
                    i.appendChild(Fs(t, void 0, e, !0));
            else {
                const s = Ls(t, e.TeX.delimiters);
                if (1 === s.length && 'text' === s[0].type) return null;
                i = document.createDocumentFragment();
                for (let t = 0; t < s.length; t++)
                    'text' === s[t].type
                        ? i.appendChild(document.createTextNode(s[t].data))
                        : i.appendChild(Fs(s[t].data, s[t].mathstyle, e, !0));
            }
            return i;
        }
        const zs = {
                ...
                try {
                    if (
                        (((e = Object.assign(
                            ...
                            zs,
                            e
                        )).ignoreClassPattern = new RegExp(e.ignoreClass)),
                        (e.processClassPattern = new RegExp(e.processClass)),
                        (e.processScriptTypePattern = new RegExp(
                            e.processScriptType
                        )),
                        (e.macros = At.MACROS),
                        e.namespace)
                    ...
                    !(function t(e, i) {
                        const s = e.getAttribute(
                            'data-' + i.namespace + 'original-content'
                        );
                        if (s) {
                            const t = Fs(
                                s,
                                e.getAttribute(
                                    'data-' + i.namespace + 'mathstyle'
                                ),
                                i,
                                !1
                            );
                            ...
                            if (
                                ...
                                if (
                                    i.TeX.processEnvironments &&
                                    /^\s*\\begin/.test(t)
                                )
                                    return (
                                        (e.textContent = ''),
                                        void e.appendChild(Fs(t, void 0, i, !0))
                                    );
                                const s = Ls(t, i.TeX.delimiters);
                                if (1 === s.length && 'math' === s[0].type)
                                    return (
                                        (e.textContent = ''),
                                        void e.appendChild(
                                            Fs(s[0].data, s[0].mathstyle, i, !0)
                                        )
                                    );
                            ...
                            for (let s = 0; s < e.childNodes.length; s++) {
                                ...
                                if (3 === a.nodeType) {
                                    const t = Ds(a.textContent, i);
                                    t &&
                                        ((s += t.childNodes.length - 1),
                                        e.replaceChild(t, a));
                                } else if (1 === a.nodeType) {
                                    const e = a.nodeName.toLowerCase();
                                    if (
                                        'script' === e &&
                                        i.processScriptTypePattern.test(a.type)
                                    ) {
                                        let t = 'displaystyle';
                                        for (const e of a.type.split(';')) {
                                            const i = e.split('=');
                                            'mode' === i[0].toLowerCase() &&
                                                (t =
                                                    'display' ===
                                                    i[1].toLoweCase()
                                                        ? 'displaystyle'
                                        ...
                                        const e = Fs(a.textContent, t, i, !0);
                                        a.parentNode.replaceChild(e, a);
                                    } else
                                        (i.processClassPattern.test(
                                            a.className
                                        ) ||
                                            (!i.skipTags.includes(e) &&
                                                !i.ignoreClassPattern.test(
                                                    a.className
                                                ))) &&
                                            t(a, i);
                                }
            ...
            if (
                ...
                if ('amazon' === e.speechEngine) {
                    if (window && window.AWS) {
                        ...
                        i.synthesizeSpeech(s, function(t, e) {
                            if (t);
        ...
        function Bs(t, e, i) {
            ...
            if (
                ...
                'amazon' !== (i = i || {}).speechEngine)
            )
                return void (i.handleSpeak && i.handleSpeak(e));
            if (!window.AWS) return;
            const s = new window.AWS.Polly({ apiVersion: '2016-06-10' }),
                a = {
                    OutputFormat: 'json',
                    VoiceId: i.speechEngineVoice || 'Joanna',
                    Text: e,
                    TextType: 'ssml',
            ...
            const o = i.onReadAloudStatus || window.mathlive.onReadAloudStatus;
            s.synthesizeSpeech(a, function(t, e) {
                if (t);
                else if (e && e.AudioStream) {
                    ...
                    for (const t of window.mathlive.readAloudMarks)
                        t.value &&
                            window.mathlive.readAloudTokens.push(t.value);
                        ...
                        s.synthesizeSpeech(a, function(t, e) {
                            if (t);
                                ...
                                window.mathlive.readAloudAudio
                                              ...
                                              const e =
                                                  1e3 *
                                                      window.mathlive
                                                          ...
                                                          .currentTime +
                                                  100;
                                              for (const i of window.mathlive
                                                  .readAloudMarks)
                                                  i.time < e && (t = i.value);
                                              window.mathlive
                                                  .readAloudCurrentMark !== t &&
                                    ...
                                    (window.mathlive.readAloudAudio.src = s),
                                    o &&
                                        o(
                ...
                if (
                    ...
                    if (((window.mathlive.readAloudFinalToken = null), t)) {
                        ...
                        for (const e of window.mathlive.readAloudMarks)
                            e.value === t && (i = e.time / 1e3);
                        let s = window.mathlive.readAloudTokens.indexOf(t);
                        s >= 0 &&
                            ((s += e),
                            s < window.mathlive.readAloudTokens.length &&
                                (window.mathlive.readAloudFinalToken = s));
                    }
                    (window.mathlive.readAloudAudio.currentTime = i),
                        window.mathlive.onReadAloudStatus &&
                            window.mathlive.onReadAloudStatus(
                                window.mathlive.readAloudMathField,
                                'playing'
