...
exports.getCharacterMetrics = exports.DEFAULT_FONT_SIZE = exports.FONT_SCALE = exports.FONT_METRICS = exports.X_HEIGHT = exports.BASELINE_SKIP = exports.AXIS_HEIGHT = exports.PT_PER_EM = void 0;
/**
 ...
 *
 */
var font_metrics_data_1 = require("./font-metrics-data");
// This regex combines
// - Hiragana: [\u3040-\u309F]
// - Katakana: [\u30A0-\u30FF]
// - CJK ideograms: [\u4E00-\u9FAF]
...
exports.FONT_METRICS = {
    ...
    stretch: [0.0, 0.0, 0.0],
    shrink: [0.0, 0.0, 0.0],
    xHeight: [exports.X_HEIGHT, exports.X_HEIGHT, exports.X_HEIGHT],
    ...
    axisHeight: [exports.AXIS_HEIGHT, exports.AXIS_HEIGHT, exports.AXIS_HEIGHT],
...
function getCharacterMetrics(codepoint, fontName) {
    ...
    if (codepoint === undefined)
        codepoint = 77; // 'M'
    var metrics = font_metrics_data_1["default"][fontName][codepoint];
    if (metrics) {
        return {
...
exports.getCharacterMetrics = getCharacterMetrics;
//
