...
exports.svgBodyHeight = exports.svgBodyToMarkup = void 0;
var SVG_BODY = {
...
function svgBodyToMarkup(svgBodyName) {
    if (SVG_ACCENTS[svgBodyName]) {
        var _a = SVG_ACCENTS[svgBodyName], vbWidth = _a[0], vbHeight = _a[1], height_1 = _a[2];
        var result = "<span class=\"ML__stretchy\" style=\"height:".concat(height_1, "em\">") +
            "<svg width=\"100%\" height=\"".concat(height_1, "em\" ") +
            "viewBox=\"0 0 ".concat(vbWidth, " ").concat(vbHeight, "\" ") +
            "preserveAspectRatio=\"none\" >" +
            "<path fill=\"currentcolor\" d=\"".concat(PATHS[svgBodyName], "\"></path>") +
            "</svg></span>";
        return "<span style=\"display:inline-block;height:".concat(Math.floor((100 * height_1) / 2) / 100, "em;min-width:0\">").concat(result, "</span>");
    }
    var _b = SVG_BODY[svgBodyName], paths = _b[0], minWidth = _b[1], viewBoxHeight = _b[2], align = _b[3];
    var widthClasses;
    var aligns;
    ...
    var body = paths
        .map(function (path, i) {
        return "<span class=\"".concat(widthClasses[i], "\" style=height:").concat(height, "em>") +
            "<svg width=400em height=".concat(height, "em ") +
            "viewBox=\"0 0 400000 ".concat(viewBoxHeight, "\" ") +
            "preserveAspectRatio=\"".concat(aligns[i], " slice\">") +
            "<path fill=\"currentcolor\" d=\"".concat(PATHS[path], "\"></path>") +
            "</svg></span>";
    })
        .join('');
    return "<span style=\"display:inline-block;height:".concat(height, "em;min-width:").concat(minWidth, "em;\">").concat(body, "</span>");
}
exports.svgBodyToMarkup = svgBodyToMarkup;
...
exports.svgBodyHeight = svgBodyHeight;
