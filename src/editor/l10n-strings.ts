...
export const STRINGS = {
  ...
  'it': {
    ...
    'menu.borders': 'Delimitatori',
    'menu.insert matrix': 'Inserisci matrice',
    'menu.array.add row above': 'Aggiungi riga sopra',
    'menu.array.add row below': 'Aggiungi riga sotto',
    ...
    'tooltip.roman-upright': 'Romano diritto',

    'tooltip.row-by-col': '%@ × %@',

    'menu.font-style': 'Stile carattere',
    'menu.accent': 'Accento',
  ...
  // Japanese
  'ja': {
    'keyboard.tooltip.symbols': '記号',
    'keyboard.tooltip.greek': 'ギリシア文字',
    'keyboard.tooltip.numeric': '数値',
    'keyboard.tooltip.alphabetic': 'ローマ字',
    'tooltip.copy to clipboard': 'クリップボードにコピー',
    'tooltip.cut to clipboard': 'クリップボードに切り取り',
    'tooltip.paste from clipboard': 'クリップボードから貼り付け',
    'tooltip.redo': 'やり直し',
    'tooltip.toggle virtual keyboard': '仮想キーボードの切り替え',
    'tooltip.menu': 'メニュー',
    'tooltip.undo': '元に戻す',
    'menu.borders': '行列の区切り文字',
    'menu.insert matrix': '行列を挿入',
    ...
    'menu.array.delete rows': '選択した行を削除',
    'menu.array.delete column': '列を削除',
    'menu.array.delete columns': '選択した列を削除',
    ...
    'menu.insert': '挿入',
    'menu.insert.abs': '絶対値',
    'menu.insert.nth-root': 'n 乗根',
    'menu.insert.log-base': '底が a の対数',
    'menu.insert.heading-calculus': '微積分',
    'menu.insert.derivative': '導関数',
    'menu.insert.nth-derivative': 'n 階導関数',
    'menu.insert.integral': '積分',
    'menu.insert.sum': '総和',
    'menu.insert.product': '総積',
    'menu.insert.heading-complex-numbers': '複素数',
    'menu.insert.modulus': '絶対値',
    'menu.insert.argument': '偏角',
    'menu.insert.real-part': '実部',
    'menu.insert.imaginary-part': '虚部',
    'menu.insert.conjugate': '共役複素数',

    'tooltip.blackboard': '黒板',
    'tooltip.bold': '太字',
    'tooltip.italic': 'イタリック体',
    ...
    'menu.cut': '切り取り',
    'menu.copy': 'コピー',
    'menu.copy-as-latex': 'LaTeX としてコピー',
    'menu.copy-as-typst': 'Typst としてコピー',
    'menu.copy-as-ascii-math': 'ASCII Math としてコピー',
    'menu.copy-as-mathml': 'MathML としてコピー',
    'menu.paste': '貼り付け',
