export const STRINGS = {
  ...
  // Catalan
  ca: {
    'keyboard.tooltip.symbols': 'Símbols',
    'keyboard.tooltip.greek': 'Lletres gregues',
    'keyboard.tooltip.numeric': 'Numèric',
    'keyboard.tooltip.alphabetic': 'Lletres romanes',
    
    'tooltip.copy to clipboard': 'Copia al porta-retalls',
    'tooltip.redo': 'Refés',
    'tooltip.toggle virtual keyboard': 'Commuta el teclat virtual',
    'tooltip.undo': 'Desfés',
    'tooltip.cut to clipboard': 'Retalla al porta-retalls',
    'tooltip.paste from clipboard': 'Enganxa des del porta-retalls',
    'tooltip.menu': 'Menú',
    
    'menu.insert matrix': 'Insereix matriu',
    'menu.insert': 'Insereix',
    'menu.insert.abs': 'Valor absolut',
    'menu.insert.abs-template': '|%@|',
    'menu.insert.nth-root': 'Arrel n-èsima',
    'menu.insert.nth-root-template': '\\sqrt[%@]{%@}',
    'menu.insert.log-base': 'Logaritme en base',
    'menu.insert.log-base-template': '\\log_{%@}(%@)',
    'menu.insert.heading-calculus': 'Càlcul',
    'menu.insert.derivative': 'Derivada',
    'menu.insert.derivative-template': '\\frac{d}{d%@}(%@)',
    'menu.insert.nth-derivative': 'Derivada n-èsima',
    'menu.insert.nth-derivative-template': '\\frac{d^%@}{d%@^%@}(%@)',
    'menu.insert.integral': 'Integral',
    'menu.insert.integral-template': '\\int_{%@}^{%@}%@\\,d%@',
    'menu.insert.sum': 'Sumatori',
    'menu.insert.sum-template': '\\sum_{%@=%@}^{%@}%@',
    'menu.insert.product': 'Productori',
    'menu.insert.product-template': '\\prod_{%@=%@}^{%@}%@',
    'menu.insert.heading-complex-numbers': 'Nombres complexos',
    'menu.insert.modulus': 'Mòdul',
    'menu.insert.modulus-template': '|%@|',
    'menu.insert.argument': 'Argument',
    'menu.insert.argument-template': '\\arg(%@)',
    'menu.insert.real-part': 'Part real',
    'menu.insert.real-part-template': '\\Re(%@)',
    'menu.insert.imaginary-part': 'Part imaginària',
    'menu.insert.imaginary-part-template': '\\Im(%@)',
    'menu.insert.conjugate': 'Conjugat',
    'menu.insert.conjugate-template': '\\overline{%@}',
    'menu.borders': 'Delimitadors de matriu',
    'menu.array.add row above': 'Afegeix fila a sobre',
    'menu.array.add row below': 'Afegeix fila a sota',
    'menu.array.add column after': 'Afegeix columna a la dreta',
    'menu.array.add column before': "Afegeix columna a l'esquerra",
    'menu.array.delete row': 'Suprimeix fila',
    'menu.array.delete rows': 'Suprimeix files seleccionades',
    'menu.array.delete column': 'Suprimeix columna',
    'menu.array.delete columns': 'Suprimeix columnes seleccionades',
    'menu.mode': 'Mode',
    'menu.mode-math': 'Matemàtiques',
    'menu.mode-text': 'Text',
    'menu.mode-latex': 'LaTeX',
    
    'tooltip.blackboard': 'Pissarra',
    'tooltip.bold': 'Negreta',
    'tooltip.italic': 'Cursiva',
    'tooltip.fraktur': 'Fraktur',
    'tooltip.script': 'Script',
    'tooltip.caligraphic': 'Cal·ligràfic',
    'tooltip.typewriter': "Màquina d'escriure",
    'tooltip.roman-upright': 'Romà vertical',
    'tooltip.row-by-col': '%@ × %@',
    
    'menu.font-style': 'Estil de lletra',
    'menu.accent': 'Accent',
    'menu.decoration': 'Decoració',
    'menu.color': 'Color',
    'menu.background-color': 'Fons',
    'menu.evaluate': 'Avalua',
    'menu.simplify': 'Simplifica',
    'menu.solve': 'Resol',
    'menu.solve-for': 'Resol per a %@',
    
    'menu.cut': 'Retalla',
    'menu.copy': 'Copia',
    'menu.copy-as-latex': 'Copia com a LaTeX',
    'menu.copy-as-ascii-math': 'Copia com a ASCII Math',
    'menu.copy-as-mathml': 'Copia com a MathML',
    'menu.paste': 'Enganxa',
    ...
    'color.magenta': 'Magenta',
    'color.black': 'Negre',
    'color.dark-grey': 'Gris fosc',
    'color.grey': 'Gris',
    'color.light-grey': 'Gris clar',
    'color.white': 'Blanc',
  },
  ...
  cs: {
    ...
    'tooltip.menu': 'Menu',
    'tooltip.undo': 'Zpět',
    'menu.borders': 'Ohraničení',
    'menu.insert matrix': 'Vložit matici',
    'menu.array.add row above': 'Přidat řádek nad',
    'menu.array.add row below': 'Přidat řádek pod',
    'menu.array.add column after': 'Přidat sloupec za',
    'menu.array.add column before': 'Přidat sloupec před',
    ...
    'menu.insert.nth-root-template': '\\sqrt[n]{x}',
    'menu.insert.log-base': 'Logaritmus o základu a',
    'menu.insert.log-base-template': '\\log_a(x)',
    'menu.insert.heading-calculus': 'Kalkulus',
    'menu.insert.derivative': 'Derivace',
    'menu.insert.derivative-template':
      '\\dfrac{\\mathrm{d}}{\\mathrm{d}x}f(x)\\bigm|_{x=a}',
    'menu.insert.nth-derivative': 'n-tá derivace',
    'menu.insert.nth-derivative-template':
      '\\dfrac{\\mathrm{d}^n}{\\mathrm{d}x^n}f(x)\\bigm|_{x=a}',
    'menu.insert.integral': 'Integrál',
    'menu.insert.integral-template': '$\\int_a^b f(x)\\,\\mathrm{d}x$',
    ...
    'menu.insert.product-template': '\\prod_{i=1}^n x_i',
    'menu.insert.heading-complex-numbers': 'Komplexní čísla',
    'menu.insert.modulus': 'Modul',
    'menu.insert.modulus-template': '\\lvert z \\rvert',
    'menu.insert.argument': 'Argument',
    'menu.insert.argument-template': '\\arg(z)',
    'menu.insert.real-part': 'Reálná část',
    'menu.insert.real-part-template': '\\Re(z)',
    'menu.insert.imaginary-part': 'Imaginární část',
    'menu.insert.imaginary-part-template': '\\Im(z)',
    'menu.insert.conjugate': 'Komplexně sdružené',
    'menu.insert.conjugate-template': '\\overline{z}',

    'tooltip.blackboard': 'Tabule',
    'tooltip.bold': 'Tučné',
    'tooltip.italic': 'Kurzíva',
    'tooltip.fraktur': 'Fraktura',
    'tooltip.script': 'Script',
    'tooltip.caligraphic': 'Kaligrafické',
    'tooltip.typewriter': 'Psací stroj',
    'tooltip.roman-upright': 'Římské vzpřímené',

    'tooltip.row-by-col': '%@ × %@',

    'menu.font-style': 'Styl písma',
    'menu.accent': 'Diakritika',
    'menu.decoration': 'Dekorace',
    'menu.color': 'Barva',
    'menu.background-color': 'Pozadí',
    'menu.evaluate': 'Vyhodnotit',
    'menu.simplify': 'Zjednodušit',
    'menu.solve': 'Řešit',
    'menu.solve-for': 'Řešit pro %@',

    'menu.cut': 'Vyjmout',
    'menu.copy': 'Kopírovat',
    'menu.copy-as-latex': 'Kopírovat jako LaTeX',
    'menu.copy-as-ascii-math': 'Kopírovat jako ASCII Math',
    'menu.copy-as-mathml': 'Kopírovat jako MathML',
    'menu.paste': 'Vložit',
    'menu.select-all': 'Vybrat vše',

    // Barvy (přístupné popisky v paletě barev)
    'color.red': 'Červená',
    'color.orange': 'Oranžová',
    'color.yellow': 'Žlutá',
    'color.lime': 'Limetková',
    ...
    'color.black': 'Černá',
    'color.dark-grey': 'Tmavě šedá',
    'color.grey': 'Šedá',
    'color.light-grey': 'Světle šedá',
    'color.white': 'Bílá',
  },
};
