...
• **parseMode**: [`ParseMode`](#parsemode)= `'math'`
...
**See**
[Guide: Speech](https://cortexjs.io/mathlive/guides/speech/)
...
• **environment**: [`TabularEnvironment`](#tabularenvironment)
...
**See* [Guide: Virtual Keyboards](https://cortexjs.io/mathlive/guides/virtual-keyboards)
...
<a id="alignenvironment" name="alignenvironment"></a>
...
<a id="argumenttype" name="argumenttype"></a>
...
<a id="boxcssproperties" name="boxcssproperties"></a>
...
<a id="casesenvironment" name="casesenvironment"></a>
...
```ts
type CasesEnvironment: "cases" | "dcases" | "rcases";
```
...
```ts
type Environment: "math" | "displaymath" | "center" | TabularEnvironment;
```
...
<a id="matrixenvironment" name="matrixenvironment"></a>
...
<a id="parsemode" name="parsemode"></a>
...
```ts
type ParseMode: "math" | "text" | "latex";
```
...
<a id="tabularenvironment" name="tabularenvironment"></a>
