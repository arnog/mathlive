...
(0, definitions_utils_1.defineSymbols)('0123456789/@.?!');
(0, definitions_utils_1.defineSymbolRange)(0x0041, 0x005a); // a-z
(0, definitions_utils_1.defineSymbolRange)(0x0061, 0x007a); // A-Z
// Quantifiers
(0, definitions_utils_1.defineSymbols)([
    ['\\forall', 0x2200],
    ['\\exists', 0x2203],
...
(0, definitions_utils_1.defineFunction)(['!', ',', ':', ';', '>', 'enskip', 'enspace', 'quad', 'qquad'], '', {
    createAtom: function (options) { return new spacing_1.SpacingAtom(options); }
});
(0, definitions_utils_1.defineFunction)('space', '', {
    createAtom: function (options) { return new spacing_1.SpacingAtom(options); }
});
// Punctuation
(0, definitions_utils_1.defineSymbols)([
