...
var ChemAtom = /** @class */ (function (_super) {
    __extends(ChemAtom, _super);
    function ChemAtom(command, arg) {
        var _this = _super.call(this, { type: 'chem' }, { command: command, mode: 'math' }) || this;
        var tex = texify.go(mhchemParser.go(arg, command === '\\pu' ? 'pu' : 'ce'), false);
        _this.body = (0, parser_1.parseLatex)(tex);
        _this._verbatimLatex = command + '{' + arg + '}';
        _this.arg = arg;
        _this.captureSelection = true;
        return _this;
    }
    ChemAtom.fromJson = function (json) {
        return new ChemAtom(json.command, json.arg);
    };
    Object.defineProperty(ChemAtom.prototype, "verbatimLatex", {
        get: function () {
    ...
    ChemAtom.prototype.toJson = function () {
        return __assign(__assign({}, _super.prototype.toJson.call(this)), { arg: this.arg });
    };
    ChemAtom.prototype.render = function (context) {
        var box = atom_class_1.Atom.createBox(context, this.body, { type: 'inner' });
        if (this.caret)
    ...
    ChemAtom.prototype._serialize = function (_options) {
        console.assert(this.verbatimLatex !== undefined);
        return this.verbatimLatex;
    };
    return ChemAtom;
}(atom_class_1.Atom));
exports.ChemAtom = ChemAtom;
(0, definitions_utils_1.defineFunction)(['ce', 'pu'], '{chemformula:balanced-string}', {
    createAtom: function (options) { var _a; return new ChemAtom(options.command, (_a = options.args[0]) !== null && _a !== void 0 ? _a : ''); }
});
/* -*- Mode: Javascript; indent-tabs-mode:nil; js-indent-level: 2 -*- */
/* vim: set ts=2 et sw=2 tw=80: */
/*************************************************************
