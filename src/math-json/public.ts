...
export type Expression =
    ...
    | string
    | MathJsonFunction
    // Stricly speaking, the first element of the array is a string, the other
    // are `Expression | null` but there isn't a way to express this
    // in TypeScript 3.9.5
 ...
 *
 */
export declare function getDefaultDictionary(
